  ...
  [7271],
  {
    ...
    81319: (e, t, s) => {
      ...
      class r {
        ...
        name() {
          return (0, n.isAllSearchSourcesSelected)(this) ? o.t(null, void 0, s(64498)) : this._exchange.name
        }
        description() {
        ...
        constructor(e) {
          ...
          const t = new Set(this._loadRecent().reverse()),
            ...
            d = l.map((e) => {
              ...
              if (t) return Promise.resolve(m.QualifiedSources.fromSymbolInfo(t))
              const s = e.symbol()
          ...
          Promise.all(d).then((e) => {
            ...
            e.forEach((e, n) => {
              const r = o[n],
                i = r.id()
              this._addStudyIdToCheckedSymbols(e, i), this._idToStudyMap.set(i, r), t.has(e) ? s.add(e) : a.add(e)
            })
              ...
              ;(e = []),
                this._chartWidget.compareSymbols() &&
                  this._chartWidget.compareSymbols().forEach((t) => {
                    e.push((0, m.qualifyProName)(t.symbol)), this._defaultSymbolsDescriptions.set(t.symbol, t.title)
                  })
              const t = [...r, ...e]
              n.push(...t)
            } else n.push(...r)
            const i = Array.from(new Set(n))
            {
              ...
              Promise.all(t).then((t) =>
                this._handleInitProcess(
                  ...
                  (e, t, s, o) =>
                    'symbol_resolved' === e.method ? f(e.params[1], s, o) : b(t, s, o, this._getSymbolDescription(t))
                )
              )
            }
          })
          ...
          ;(() => {
            ...
            Promise.all([this._getResolveSymbolPromise(e), n]).then((t) =>
              this._handleApplyProcess(
                ...
                (e, t, s) => ('symbol_resolved' === e.method ? f(e.params[1], !0, s) : b(t, !0, s))
              )
            ),
              v.emit('add_compare')
          })()
