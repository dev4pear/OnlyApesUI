    ...
    54819: (o, e, l) => {
      ...
      const r = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1),
        ...
        v = {
          ...
          LineToolIcon: { icon: a.lineToolsIcons.LineToolIcon, localizedName: s.lineToolsLocalizedNames.LineToolIcon },
          LineToolEmoji: {
    ...
    71810: (o, e, l) => {
      ...
      !(function (o) {
        function e() {
          ...
          o.favorites = []
          let s = !1
          const c = Boolean(void 0 === (0, a.getValue)('chart.favoriteDrawings')),
            r = (0, a.getJSON)('chart.favoriteDrawings', [])
          if (0 === r.length && c && 'undefined' != typeof window) {
            const o = JSON.parse(
              null !== (n = null === (e = window.urlParams) || void 0 === e ? void 0 : e.favorites) && void 0 !== n
                ? n
                : '{}'
            ).drawingTools
          ...
          r.forEach((e, i) => {
            const n = e.tool || e
            l(n) ? (t.includes(n) ? (s = !0) : o.favorites.push(n)) : 'LineToolTweet' === n && (o.tweetToolPosition = i)
          }),
            s && i(),
        ...
        (function (o) {
          ...
          ;(o.favoriteAdded = new (n())()),
            ...
            (o.addFavorite = function (l, n) {
              return !(i(l) || !e(l)) && (s.favorites.push(l), s.saveFavorites(n), o.favoriteAdded.fire(l), !0)
            }),
            (o.removeFavorite = function (e, l) {
              ...
              return (
                null !== n && n > i && (s.tweetToolPosition = n - 1), s.saveFavorites(l), o.favoriteRemoved.fire(e), !0
              )
            }),
            (o.isFavorite = i),
            (o.moveFavorite = function (i, n, a) {
              ...
              return (
                null !== c && (t < c && n > c ? c-- : n < c && t > c && c++, (s.tweetToolPosition = c)),
