;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306],
  {
    ...
    94720: (t, e, o) => {
      ...
      function d(t) {
        const { startIcon: e, icon: o, iconOnly: n, children: s, endIcon: a, primaryText: c, secondaryText: d } = t,
          h = null != e ? e : o,
          p = !(e || o || a || n) && !s && c && d
        return i.createElement(
          i.Fragment,
          null,
          h && i.createElement(r.Icon, { icon: h, className: l()['start-icon-wrap'] }),
          s && i.createElement('span', { className: l().content }, s),
          a && !n && i.createElement(r.Icon, { icon: a, className: l()['end-icon-wrap'] }),
          p &&
            (function (t) {
              return (
                t.primaryText &&
      ...
      function u(t) {
        ...
        return { ...g, ...(0, p.filterDataProps)(t), ...(0, p.filterAriaProps)(t) }
      }
      function g(t) {
    ...
    70114: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        _ = o(12005)
      function m(t) {
        const { property: e, icon: o, propertyApplier: n, title: m, undoText: v, className: y } = t,
          w = (0, g.useProperty)(e),
          b = (0, i.useRef)(null),
          f = w ? (0, l.parseRgba)(w)[3] : void 0,
          C = '' === w,
          P = String(W()).toLowerCase() === p.white,
          [S, x, T] = (0, d.useCustomColors)()
        return i.createElement(
          u.ToolWidgetMenu,
          {
            className: y,
            content: i.createElement(
              ...
              i.createElement(
                ...
                { className: _.colorBg },
                i.createElement('div', {
                  className: s()(_.color, C && _.multicolor, P && _.white),
          ...
          i.createElement(h.ColorPicker, {
            ...
            onOpacityChange: function (t) {
              E((0, c.generateColor)(w, (0, c.alphaToTransparency)(t), !0))
            },
    ...
    27797: (t, e, o) => {
        ...
        return i.createElement(
          ...
          i.createElement('div', {
            ...
            className: n(
              ...
              a && _.selected,
              !s && _.empty,
              String(s).toLowerCase() === u.white && _.white
            ),
            onClick: function () {
              m(s)
            },
          ...
          f &&
            i.createElement(
              d.PopupMenu,
              {
                ...
                onClose: C,
                position: function () {
                  const t = (0, l.ensureNotNull)(b.current).getBoundingClientRect()
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: S.pointer, style: { top: 100 * e + '%' } })
            )
          )
        }
      }
        ...
        render() {
          ...
          return i.createElement(
            ...
            i.createElement(
              'div',
              { className: T.form },
              i.createElement('div', { className: T.swatch, style: { backgroundColor: t } }),
              i.createElement(
                'div',
                { className: T.inputWrap },
                i.createElement('span', { className: T.inputHash }, '#'),
                i.createElement('input', { type: 'text', className: T.input, value: o, onChange: this._handleInput })
              ),
              i.createElement(
                'div',
                { className: T.buttonWrap },
                i.createElement(w.Button, { size: 's', onClick: this._handleAddColor }, E)
              )
            ),
            i.createElement(
              'div',
              { className: T.hueSaturationWrap },
              i.createElement(P, { className: T.saturation, hsv: e, onChange: this._handleHSV }),
              i.createElement(x, { className: T.hue, hsv: e, onChange: this._handleHSV })
            )
          )
        }
      }
      ...
      const k = r.t(null, { context: 'Color Picker' }, o(53585)),
        N = r.t(null, { context: 'Color Picker' }, o(81865))
      class D extends i.PureComponent {
        ...
        render() {
          ...
          return l
            ? i.createElement(L, { color: t, onSelect: this._handleSelectColor, onAdd: this._handleAddColor })
            : i.createElement(
                'div',
                ...
                n &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement('div', { className: B.sectionTitle }, N),
                    i.createElement(y.Opacity, { color: t, opacity: c, onChange: this._handleOpacity })
                  )
              )
        }
        _onToggleCustom(t) {
    ...
    9629: (t, e, o) => {
      'use strict'
      o.r(e), o.d(e, { FavoriteDrawingToolbar: () => v })
      var i = o(44352),
        n = o(3809),
        s = o(71810),
        r = (o(50151), o(32563)),
        ...
        m = o(29673)
      o(70132)
      class v extends n.FloatingToolbar {
        constructor(t) {
          super({
        ...
        showAndSaveSettingsValue() {
          this._canBeShownValue.value() &&
            (u.TVLocalStorage.setItem('ChartFavoriteDrawingToolbarWidget.visible', 'true'), this.show())
        }
        ...
        _onFavoriteAdded(t) {
          this.addWidget(this._createLinetoolWidget(t)),
            s.LinetoolsFavoritesStore.favorites().filter(y).length > 0 &&
        ...
        _onFavoriteRemoved(t) {
          this.removeWidget(this._linetoolsWidgets[t]),
            ...
            0 === s.LinetoolsFavoritesStore.favorites().filter(y).length &&
        ...
        _loadVisibilityState() {
          const t = s.LinetoolsFavoritesStore.favorites().filter(y).length > 0
    ...
    3809: (t, e, o) => {
      'use strict'
      o.d(e, { FLOATING_TOOLBAR_REACT_WIDGETS_CLASS: () => C, FloatingToolbar: () => S })
      var i = o(59064),
        n = o(32563),
        s = o(61345),
        r = o(56840),
        ...
        constructor(t) {
          ...
          ;(this._helper = null),
            (this._handleDragStart = (t) => {
              ...
              const [i, n] = [(0, _.outerWidth)(o), (0, _.outerHeight)(o)]
              ;(this._helper = {
      ...
      class y {
        ...
        _getEventTarget() {
          return m.CheckMobile.iOS() || ((0, m.isMac)() && n.touch) ? window.document.documentElement : this._handle
        }
        _dispatchEvent(t) {
          switch (t.type) {
      ...
      const C = 'floating-toolbar-react-widgets',
        P = `<div class="tv-floating-toolbar i-closed i-hidden"><div class="tv-floating-toolbar__widget-wrapper"><div class="tv-floating-toolbar__drag js-drag">${f}</div><div class="tv-floating-toolbar__content js-content"></div><div class="${C}"></div></div></div>`
      class S {
        constructor(t) {
          ;(this._widget = document.createElement('div')),
            ...
            (this._options = t),
            (this._widget = (0, w.parseHtmlElement)(P)),
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, o) => {
              ...
              t !== i && ((0, b.trackEvent)('Floating Toolbar', 'User Sort'), this._reorderedDelegate.fire(t, i))
            },
            tolerance: 'pointer',
            distance: 5,
    ...
    89824: (t, e, o) => {
      ...
      var v = o(69152),
        ...
        w = o(3809),
        b = o(24437)
      const f = w.FLOATING_TOOLBAR_REACT_WIDGETS_CLASS + '__button'
      function C(t) {
        const {
            templateButton: e,
            propertyButtons: o,
        ...
        return a && a.length
                        ...
                        n.map((o, n) => {
                          ...
                          return s
                            ? o.showForSmallScreen
                              ...
                              : null
                            : i.createElement(o.component, { ...o.props, key: `${o.props.title}_${n}`, className: f })
                        })
                    )
                )
            )
          : l()
        function l() {
          return null === e ? null : i.createElement(e.component, { ...e.props, isDrawingFinished: s, className: f })
        }
      }
      var P = o(51768),
        S = o(50813),
      ...
      function T(t) {
        ...
        return i.createElement(S.ToolWidgetIconButton, {
          ...
          onClick: async function () {
            ;(0, P.trackEvent)('GUI', 'Context action on drawings', 'Settings')
      ...
      function k(t) {
        ...
        return i.createElement(L.ToolButton, { className: E(e, B.button), tooltipPosition: 'horizontal', ...o })
      }
      var N = o(65186),
        D = o(91244)
      function I(t) {
        ...
        const a = r[0].properties().frozen,
          l = (0, W.useProperty)(a),
          c = l ? { title: s.t(null, void 0, o(15101)), icon: N } : { title: s.t(null, void 0, o(42284)), icon: D }
        return i.createElement(k, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
            ;(0, P.trackEvent)('GUI', 'Context action on drawings', 'Lock'), e.toggleLockSelectedObject()
          },
      ...
      function A(t) {
        ...
        return i.createElement(S.ToolWidgetIconButton, {
          ...
          'data-name': 'remove',
          onClick: function () {
            ;(0, P.trackEvent)('GUI', 'Context action on drawings', 'Remove'), o.removeSelectedSources()
          },
        })
      }
      var R = o(9745),
        ...
        $ = o(84959)
      function G(t, e) {
        const i = [(0, U.createVisualOrderAction)(t, e), (0, U.createChangeIntervalsVisibilitiesAction)(t, e)],
          n = (function (t, e) {
            const i = [],
              n = H.isMacKeyboard ? ' +' : '',
              r = e.filter((t) => t.cloneable())
            r.length > 0 &&
              i.push(
                new Z.Action({
                  ...
                  name: 'clone',
                  icon: o(36296),
                  shortcutHint: H.humanReadableModifiers(j.Modifiers.Mod) + n + ' Drag',
                  label: s.t(null, void 0, o(52977)),
                  onExecute: () => {
                    t.model().cloneLineTools(r, !1), (0, P.trackEvent)('GUI', 'Context action on drawings', 'Clone')
                  },
                })
              )
            ...
            if (a.length > 0) {
              const e = {
                ...
                shortcutHint: H.humanReadableModifiers(j.Modifiers.Mod) + n + ' C',
                onExecute: () => {
            ...
            return (function (t, e) {
              ...
              ? (i.push(...(0, U.createSyncDrawingActions)(t, e)), i)
              : i
          })(t, e)
        return (
      ...
      var q = o(44996)
      function Y(t) {
        const { title: e, activeChartWidget: o, isSmallScreen: n, className: s } = t,
          r = o.model().selection().lineDataSources(),
          [a, l] = (0, i.useState)([]),
          c = (0, i.useRef)(null),
          d = (0, i.useMemo)(() => new U.ActionsProvider(o), [o]),
          h = (0, i.useCallback)(() => d.contextMenuActionsForSources(r), [d, r]),
          p = (0, i.useCallback)(() => {
            if (n) return
            const t = G(o, r)
            l(K(t))
      ...
      var X = o(95586),
        ...
        tt = o(57740)
      function et(t) {
        const { property: e, propertyApplier: n, title: r, undoText: a, className: l } = t,
          c = (0, W.useProperty)(e),
          d = (0, i.useMemo)(
            () => [
              new Z.Action({
        ...
        return i.createElement(
          F.ToolWidgetMenu,
          {
            className: l,
            arrow: !1,
            content: i.createElement(R.Icon, { icon: ot(c) }),
            title: r,
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
          },
      ...
      const it = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40]
      function nt(t) {
        ...
        return i.createElement(
          ...
          i.createElement(z.ActionsTable, { items: l })
        )
      }
      var st = o(57898),
        rt = o.n(st)
      ...
      class at extends w.FloatingToolbar {
        constructor(t) {
          super(at._prepareOptions(t)),
            (this._onWidgetStateChangedDelegate = new (rt())()),
            (this._statedWidgets = []),
      ...
      var lt = o(69774),
        ...
        pt = o(87919),
        ut = o(46627)
      const gt = new r.TranslatedString('change line tool(s) font size', s.t(null, void 0, o(36819))),
        _t = new r.TranslatedString('change line tool(s) line style', s.t(null, void 0, o(54769))),
        mt =
          (new r.TranslatedString('apply drawing template', s.t(null, void 0, o(49037))), s.t(null, void 0, o(89517))),
        vt = s.t(null, void 0, o(34596)),
        yt = s.t(null, void 0, o(41610)),
        wt = s.t(null, void 0, o(32733)),
        bt = s.t(null, void 0, o(17006))
      class ft {
        constructor(t) {
        ...
        _createSettingsButton() {
          const t = { component: T, props: { title: mt, activeChartWidget: this.activeChartWidget() } }
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ? new m(new p.MultipleLineWidthsProperty(t), this._propertyApplierImpl(), i)
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ...
              : new v.CollectibleColorPropertyDirectWrapper(new p.MultipleLineColorsProperty([t]))
        }
    ...
    26916: (t, e, o) => {
      ...
      var a = o(94071),
        ...
        p = new i('change line tool(s) text color', o(44352).t(null, void 0, o(16631))),
        u = new i('change line tool(s) line width', o(44352).t(null, void 0, o(41648))),
        ...
        P = o(44352).t(null, void 0, o(47059)),
        S = o(44352).t(null, void 0, o(36785)),
        x = o(44352).t(null, void 0, o(49593)),
        T = o(44352).t(null, void 0, o(67455)),
      ...
      class L extends n {
        ...
        _createWidthsButton(t, e) {
          if (
            ...
            return !0
          var o = C
          e && 1 !== this.selectedSources().filter((t) => t.properties().linesWidths).length && (o = P)
          return (
        ...
        showPropertiesOf(t, e, o) {
          ...
          if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
            for (var n = {}, r = 0; r < i.length; r++) {
              for (var a = i[r], l = e, c = a.name.split('.'), d = 0; d < c.length; ++d) l = l && l[c[d]]
              var h = a.showIf
        ...
        _textPropertiesExceptionCases() {
          return [
            { name: 'color', title: m, inputType: 'colorPicker', iconSvgCode: c, dataName: 'text-color', undoText: p },
            {
              name: 'backgroundColor',
              title: y,
              inputType: 'colorPicker',
            ...
            { name: 'fontsize', title: f, inputType: 'combobox', factory: L.prototype._createFontSizeButton },
          ]
        }
