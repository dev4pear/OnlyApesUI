  ...
  [4862],
  {
    ...
    67029: (e, t, n) => {
      ...
      function g(e, t, n, o) {
        const {
          ...
          y = h(null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(n))
        return r(
          d().container,
          d()[`container-${u}`],
          d()[`intent-${l}`],
      ...
      function p(e, t, n) {
        ...
        const i = h(null != s ? s : (0, c.getGroupCellRemoveRoundBorders)(t))
      ...
      function v(e, t) {
        const {
          ...
          { isGrouped: E, cellState: M, disablePositionAdjustment: D = !1 } = (0, o.useContext)(a.ControlGroupContext),
        ...
        return o.createElement(
          ...
          w,
          C,
          o.createElement('span', { className: p(e, M, k) })
        )
      }
    ...
    31261: (e, t, n) => {
        ...
        return o.createElement(h.ControlSkeleton, {
          ...
          middleSlot: o.createElement(
            ...
            o.createElement('input', {
              ...K,
              className: r(m().input, m()[`size-${j}`], A, F && m()['with-start-slot'], W && m()['with-end-slot']),
              disabled: O,
              readOnly: P,
              ref: H,
            })
      ...
      function b(e) {
        ...
        const {
          ...
          E = (0, o.useCallback)(
            (e) => {
              ;(m.current = e), g && ('function' == typeof g && g(e), 'object' == typeof g && (g.current = e))
            },
            [m, g]
          )
    ...
    48027: (e, t, n) => {
      ...
      function s(e) {
        ...
        return { ...e, intent: s || (a ? 'primary' : 'default'), highlight: null != i ? i : a, onFocus: u, onBlur: d }
      }
    },
    29202: (e, t, n) => {
      'use strict'
    ...
    23263: (e, t, n) => {
      ...
      function S(e) {
        ...
        return { ...c, ...(0, v.filterDataProps)(e), ...(0, v.filterAriaProps)(e) }
      }
      function w(e) {
        const { reference: t, children: n, iconOnly: r, startIcon: i, endIcon: l, ...a } = e,
          c = (function (e, t) {
            const {
                className: n,
                color: o = 'brand',
        ...
        return o.createElement(
          'button',
          { ...S(a), className: c, ref: t },
          i && o.createElement(s.Icon, { className: f()(_().icon, _().startIcon), icon: i }),
          !(0, b.isIconOnly)(n, r) && o.createElement('span', { className: _().content }, n),
          l && o.createElement(s.Icon, { className: f()(_().icon, _().endIcon), icon: l })
        )
      }
      n(21593)
      function C(e, t) {
      ...
      const E = o.forwardRef((e, t) => {
        const { tabs: n, size: r = 'xsmall', variant: s = 'primary', theme: i = k() } = e
        return o.createElement(
          'div',
          { className: C(i, e), ref: t },
          n.map((e) => {
            const { isChecked: t, ...n } = e
            return o.createElement(w, {
              ...n,
              className: T(i, { ...n, variant: s, isChecked: t }),
              size: r,
              variant: s,
            })
          })
      ...
      i.t(null, void 0, n(87871)), i.t(null, void 0, n(10538)), i.t(null, void 0, n(74860))
      var M = n(29540),
        D = n(28355)
      const N = (0, u.getLogger)('Chart.ManageDrawings'),
        x = new Map()
      function L(e) {
        let t = x.get(e)
        return void 0 === t && ((t = new (c())([])), x.set(e, t)), t
      }
      const z = new l.TranslatedString('remove all line tools for {symbol}', i.t(null, void 0, n(23481))),
        j = (e) =>
          i.t(null, { plural: '{drawingsCount} drawings', count: e }, n(88143)).format({
            drawingsCount: e.toString(),
          }),
        R = i.t(null, void 0, n(85128)),
        A = i.t(null, void 0, n(18570))
      function O(e) {
      ...
      function P(e) {
          ...
          [b, y, _] = o.useMemo(() => {
            ...
            if (null !== c && null !== u) {
              ...
              let n = 0,
                o = f
              if (null === o)
                for (o = 2; o > 0 && !(((null === (e = u[o].get(c)) || void 0 === e ? void 0 : e.size) || 0) > 0); ) o--
              return (
                u[o].forEach((e, o) => {
                  m.includes(o) ||
                    (t.push({
        ...
        return (
          ...
          o.createElement(
            ...
            0 === b.length
              ? null === u
                ? o.createElement(p.Spinner, { className: D.spinner })
                : o.createElement(
                    'div',
                    { className: D.empty },
                    o.createElement(s.Icon, { className: D.image, icon: M }),
                    o.createElement('span', null, A)
                  )
              : b.map(({ symbol: e, drawingsCount: n, onRemove: r, onClick: s }) =>
    ...
    82497: (e, t, n) => {
      ...
      function P(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          o.createElement('div', { className: I(A.title, A.withoutIcon) }, v.t(null, void 0, n(31095)), d),
          o.createElement(
            'div',
            { className: A.buttons },
            ...
            o.createElement(
              D.ToolWidgetMenu,
              {
                className: I(A.button, c && A.disabled),
                isDisabled: c,
            ...
            o.createElement(
              D.ToolWidgetMenu,
              {
                className: I(A.button, i && A.disabled),
                isDisabled: i,
                content: o.createElement(E.Icon, { icon: j }),
      ...
      const Z = G('SET_NODES'),
        ...
        se = G('HIDE_DROP_TARGET'),
        ie = G('START_MULTI_SELECT'),
      ...
      const Le = (e) => e.nodes,
        ...
        We = (0, xe.createSelector)([(e) => e.disabled, ze, Oe], (e, t, n) => !t.ids.includes(n) && e.includes(n)),
        ...
        Ke = (0, xe.createSelector)(Le, (e) => Object.values(e).filter((e) => 0 === e.level)),
      ...
      const qe = (0, xe.createSelector)([Le, Ke, Re], (e, t, n) => {
          const o = new Set(n)
          return t.reduce((t, n) => [...t, ...Qe(e, (0, T.ensureDefined)(n), o)], [])
        }),
      ...
      function* Xe(e) {
        ...
        yield (0, S.put)(((e) => ({ type: Z, nodes: e }))(o)), yield (0, S.put)(Se(t))
        !Ge(yield (0, S.select)()) && t.length > 0 && (yield (0, S.put)(Ie(t[0])), yield (0, S.put)(ke(t[0])))
      }
      function* et(e) {
        for (;;) {
          if ((yield (0, S.take)([ie, le])).type === ie) {
      ...
      function* tt() {
        for (;;) {
          ...
          const a = at(t, e === ne ? 'next' : 'previous', n, l),
            { id: c } = a
          s.includes(c) && r
            ? (yield (0, S.put)(Ee(r, !1, 1)), yield (0, S.put)(Ie(c)))
      ...
      function* nt(e, t) {
        for (;;) {
          ...
          const l = r.findIndex((e) => e.id === i),
            ...
            c = at(o, a, r, l),
            { id: u } = c
          e ? e([u], a) : yield (0, S.put)(Se([u])), t && t(u), yield (0, S.put)(Ie(u))
        }
      }
      function* ot(e, t = () => !0) {
        for (;;) {
          const { mode: n, nodeId: o, isSelected: r } = yield (0, S.take)(ue)
          let s = [...Ve(yield (0, S.select)())]
          const i = Ye(yield (0, S.select)())
      ...
      function* rt(e = () => !0, t) {
        ...
        u.map((e) => e.id).includes(d.id)
          ? yield (0, S.put)({ type: se })
          : h &&
            e(u, d, o) &&
            (yield (0, S.put)(((e, t, n) => ({ type: re, node: e, dropType: t, boundBox: n }))(d, o, s)))
      }
      function* st(e) {
      ...
      function at(e, t, n, o) {
        ...
        ;-1 === o && 'previous' === t && (o = r)
        let i = 0
        for (; !s || (Math.abs(i) < r && (l = s).level > 1 && !Fe(e, (0, T.ensureDefined)(l.parentId))); )
      ...
      function* ct(e = {}) {
        const {
          ...
          c = [(0, S.fork)(st, o), (0, S.fork)(it, n), (0, S.fork)(ot, s, a), (0, S.fork)(nt, s, i), (0, S.fork)(tt)]
        for (t && c.push((0, S.fork)(t)), r && c.push((0, S.fork)(lt, r)), a && c.push((0, S.fork)(et, a)); ; ) {
      ...
      const mt = (0, ut.combineReducers)({
          ...
          switch (t.type) {
            ...
            case K: {
              ...
              for (const e of n) {
                ...
                if (r.hasOwnProperty(t)) {
                  !(0, dt.deepEquals)(r[t].children, e.children)[0] && (r[t] = { ...r[t], children: [...e.children] })
                } else {
                  r[t] = e
                  const { parentId: n } = e
            ...
            case ge: {
              const { ids: n, targetId: o, dropType: r } = t,
                s = (0, T.ensureDefined)(e[o].parentId),
                i = e[s],
                l = {}
              for (const t of n) {
                const n = e[t]
        ...
        scrollToId: function (e = null, t) {
          return t.type === ce ? (null === t.nodeId ? null : { id: t.nodeId }) : e
        },
      })
      var ft = n(40933),
        vt = n(20037),
      ...
      class Mt extends o.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleRef = (e) => {
              ...
              ;(0, T.ensureDefined)(n)(this._ref),
                ...
                (0, T.ensureDefined)(o)((0, _t.getEmptyImage)(), { captureDraggingState: !0 })
            }),
        ...
        render() {
          return o.createElement(Dt, { ...this.props, reference: this._handleRef })
        }
        getNode() {
      ...
      const Dt = (e) => {
          const {
            ...
            y = (0, o.useRef)(null),
            _ = (0, St.createSafeMulticastEventHandler)((e) => (y.current = e), h)
          let [S, w] = (0, wt.useHover)()
          return (
            (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) && ((S = n), (w = { onMouseOut: Et, onMouseOver: Et })),
            o.createElement(
              'div',
              {
                className: I(kt.wrap, n && kt.selected, f && kt.childOfSelected, l && kt.disabled, s && kt.expandable),
                onClick:
                  1 === v && 0 === b
                    ? T
                    : function (e) {
              ...
              s &&
                o.createElement(E.Icon, {
                  icon: It,
                  className: I(kt.expandHandle, a && kt.expanded),
                  onClick: function (e) {
                    e.preventDefault(), s && d(t, !a)
                  },
      ...
      function xt(e, t) {
        ...
        let s = !1,
          i = o.parentId
        for (; i && !s; ) (s = Be(e, i)), (i = Pe(e, i).parentId)
        return {
          ...o,
          isSelected: r,
          isChildOfSelected: s,
            ...
            [, s] = (0, ft.useDrop)({
              ...
              hover: (n, o) => {
                ...
                if (a) {
                  ...
                  e.processDropTarget(e, n, a.x - i.left < 48, o, e.isLastChild)
                }
              },
            })
            ...
            hover: (n, o) => {
              ...
              if ('last' === e.type) {
                const t = r.x - i.left < 48,
                  n = s[s.length - 1],
                  o = t && 2 === n.level ? (0, T.ensureDefined)(s.find((e) => e.id === n.parentId)) : n,
                  a = {
                    top: i.top - l.top,
                    left: i.left - l.left,
                    bottom: i.top - l.top,
      ...
      function qt(e) {
        const { dropType: t, boundBox: n } = e,
          { top: o, bottom: r, left: s } = (0, T.ensureDefined)(n)
      ...
      const Qt = (0, F.connect)(
        ...
        const { dropType: t, boundBox: n, isDragging: r, level: s, transform: i = qt } = e
        return Pt(function () {
          if (!r || !t || !n) return null
          const l = { [$t.dropTarget]: 'inside' !== t, [$t.dropTargetInside]: 'inside' === t },
            { width: a, height: c } = n,
            [u, d] = i(e),
      ...
      const sn = o.forwardRef(function (e, t) {
        ...
        ;(0, o.useEffect)(() => {
          ...
          (0, o.useEffect)(() => {
            const e = (e) => {
                ;[C.Modifiers.Mod, C.Modifiers.Shift].includes((0, C.modifiersFromEvent)(e)) && i()
              },
              t = (e) => {
                l && ![C.Modifiers.Mod, C.Modifiers.Shift].includes((0, C.modifiersFromEvent)(e)) && s()
              }
            return (
        ...
        const B = (0, o.useCallback)((e) => {
            ...
            const { index: n } = e
            return (
              n === P.current.length - 1 && ((t = { ...t, bottom: 0, minHeight: t.height }), delete t.height),
          ...
          W = (0, o.useCallback)((e) => (0, T.ensure)(P.current[e].node.key), []),
          H = (0, o.useMemo)(
            () => (null === f ? { index: -1 } : { index: P.current.findIndex((e) => e.node.key === f.id) }),
            [f]
          )
        d(j)
        const [V, G, U, Z] = (0, Ut.useOverlayScroll)(),
          K = (0, o.useRef)(null)
        ;(0, o.useEffect)(() => (0, T.ensureNotNull)(K.current).resetAfterIndex(0, !0), [O]),
          (0, o.useEffect)(() => (0, T.ensureNotNull)(K.current).scrollToItem(H.index), [H])
        const Y = (0, o.useRef)(null),
          ...
          J = (0, o.useRef)({
            startScroll(e) {
              const t = () => {
                null !== U.current && ((q.current = requestAnimationFrame(t)), U.current.scrollBy({ top: e }))
              }
              this.stopScroll(), t()
            },
            stopScroll() {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(
              ...
              {
                ...G,
                className: k()(nn.tree, u),
                ref: j,
                tabIndex: -1,
                onKeyDown: function (e) {
                  const t = (0, C.hashFromEvent)(e)
                  if (e.defaultPrevented || (0, Rt.isNativeUIInteraction)(t, e.target)) return
                  const o = (0, T.ensureDefined)(V.scrollPosTop),
                    r = (0, T.ensureDefined)(V.contentHeight),
                    s = (0, T.ensureDefined)(V.containerHeight)
                  if (s) {
                    const n = 0.875 * s,
                      i = o + s === r
                    switch (t) {
                      case 35:
                        i || (e.preventDefault(), Q(r))
                        break
                      case 36:
                      ...
                      case 33:
                        ...
                        break
                      case 34:
                        i || (e.preventDefault(), Q(Math.min(o + n, r)))
                    }
                  }
              ...
              o.createElement(Gt.OverlayScrollContainer, { ...V, className: nn.overlayScrollWrap }),
        ...
        function Q(e) {
          var t
          null === (t = U.current) || void 0 === t || t.scrollTo({ left: 0, top: e })
        }
      })
      const ln = (0, F.connect)(
          ...
          const t = (0, o.useRef)(null),
            [{ isOver: n }, r] = (0, ft.useDrop)({
              ...
              drop: (n, o) => {
                var r
                ;('touch' === e.drag || bt.isFF) && (null === (r = t.current) || void 0 === r || r.stopScroll()),
              ...
              hover: (n, o) => {
                ...
                if (null === i) return
                const l =
                  null !== (s = null === (r = t.current) || void 0 === r ? void 0 : r.getListElement()) && void 0 !== s
                    ? s
                    : null
                if (null === l) return
                ...
                ;((n, o, r) => {
                  ...
                  const i = Math.abs(n - r),
                    l = Math.abs(n - o)
                  if ((l > 40 && i > 40) || (i <= 40 && l <= 40))
                    return void (null === (s = t.current) || void 0 === s || s.stopScroll())
                  ;((n, o, r, s) => {
                    var i, l, a, c
                    o || n
                      ? 'touch' === e.drag
                        ? null === (i = t.current) || void 0 === i || i.startScroll(o ? -5 : 5)
          ...
          return o.createElement(sn, { ...e, isOver: n, connectDropTarget: r, ref: t })
        }),
        ...
        return (
          ...
          (0, o.useEffect)(
            () => (
              null !== f &&
                a &&
                (g && (g.current = performance.now()), f.dispatch(((e) => ({ type: K, nodes: e }))(a))),
              () => {}
            ),
            [f, a]
          ),
          ...
          null === f ? null : o.createElement(un, { store: f, scrollToId: p, ...m })
        )
      }
      const un = o.memo(function (e) {
        const { store: t, scrollToId: n, ...r } = e,
          s = 'touch' === e.drag ? H.TouchBackend : W.HTML5Backend
        return (
          (0, o.useEffect)(() => {
            var e
          ...
          o.createElement(
            V.DndProvider,
            { backend: s, options: an },
            o.createElement(F.Provider, { store: t, context: Nt }, o.createElement(ln, { ...r }))
          )
        )
      })
      function dn(e, t) {
      ...
      function* mn() {
        for (;;) {
          ...
          1 === e && dn('Multi select', 'Ctrl'), 2 === e && dn('Multi select', 'Shift')
        }
      }
      function* fn(e) {
        for (;;) {
      ...
      function Tn(e) {
        const { viewModel: t, showHeader: n = !0, nodeRenderer: r, isDialog: s = !1 } = e,
          ...
          h = (0, o.useMemo)(() => ({ isTouch: w.touch, isDialog: s }), [s])
        return o.createElement(
          yn.Provider,
          { value: h },
          o.createElement(
            ...
            o.createElement(
              'div',
              { className: wn.wrap, onContextMenu: _n.preventDefaultForContextMenu },
      ...
      function Nn(e) {
        ...
        return o.createElement(E.Icon, { className: k()(Dn.button, n && Dn.disabled, t), ...r })
      }
      var xn = n(77975)
      ...
      function Zn(e) {
        const { id: t } = e,
          ...
          s = r.entity(t)
        return null === s ? null : o.createElement(Kn, { ...e, entity: s })
      }
      function Kn(e) {
        const {
            id: t,
          ...
          [O, P] = (0, o.useState)(!1),
          [B, F] = ((0, xn.useWatchedValueReadonly)({ watchedValue: g.getChartLayout() }), (0, o.useState)(!1)),
          W = (0, o.useRef)(null)
        ;(0, o.useEffect)(() => {
          const e = {}
          ...
          (0, o.useEffect)(() => {
            !i && W.current && (clearTimeout(W.current), (W.current = null)), b(!1)
          }, [i])
        const H = {}
        if (c) {
          const e = g.entity(c)
        ...
        const V = En.enabled('test_show_object_tree_debug') ? `<${u.id()}> (${u.zOrder()}) ${u.title()}` : u.title(),
          G = a || O,
          U = f && i,
          Z = !!p && p.isTouch,
          K = !!p && p.isDialog,
        ...
        let q = null
        return (
          w && w.type === kn.Svg && (q = o.createElement(E.Icon, { icon: w.content || '', className: Un.icon })),
          o.createElement(
            'span',
            {
              className: I(
              ...
              onMouseDown: function (e) {
                f && !(0, T.ensureNotNull)(y.current).contains(e.target) && F(!0)
              },
              onClick:
                1 === m
                  ? J
                  : function (e) {
                      ...
                      if (W.current)
                        e.preventDefault(), clearTimeout(W.current), (W.current = null), g.openProperties(u), F(!1)
                      else {
                        const e = g.selection().selected()
                        W.current = setTimeout(() => {
                          ;(W.current = null), i && !B && 1 === e.length && g.rename(u, () => b(!0)), F(!1)
                        }, 500)
                      }
                    },
            ...
            !U &&
              o.createElement(
                ...
                o.createElement(
                  'span',
                  { className: I(Un.title, g.isMain(u) && Un.main, (!u.isVisible() || !z) && Un.disabled), ...H },
                  V
                ),
                o.createElement(
                  'span',
                  ...
                  u.canBeLocked() &&
                    o.createElement(Nn, {
                      title: M ? jn : Rn,
                      icon: M ? Wn : Hn,
                      className: I(Un.button, (G || M) && Un.visible, 'apply-common-tooltip'),
                      onClick: function (e) {
                        if (e.defaultPrevented) return
                  ...
                  o.createElement(Nn, {
                    icon: Y,
                    className: I(Un.button, !z && Un.warn, (G || !N || !z) && Un.visible, 'apply-common-tooltip'),
                    onClick: z
                      ? function (e) {
                          if (e.defaultPrevented) return
                      ...
                      : function (e) {
                          if (e.defaultPrevented) return
                          e.preventDefault(), g.openProperties(u, Bn.TabNames.visibility)
                        },
                    title: (function () {
                      if (!z) return $
                      return N ? An : On
                  ...
                  u.canBeRemoved() &&
                    o.createElement(Nn, {
                      title: Pn,
                      icon: Fn,
                      className: I(Un.button, (Z || G) && Un.visible, 'apply-common-tooltip'),
                      onClick: function (e) {
                        if (e.defaultPrevented) return
      ...
      function qn(e) {
        ...
        return o.createElement(
          Ct.Provider,
          { value: r },
          o.createElement(Tn, { nodeRenderer: Zn, showHeader: !1, viewModel: n, isDialog: !0 })
        )
      }
      var Jn = n(16216),
        Qn = n(98310),
      ...
      class ro {
        constructor(e) {
          ;(this._onChange = new (eo())()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map((e) => no(e.id, e.instanceId())),
            ...
            for (const n of this._groupModel.groups()) {
              ...
              if (r.pane() === t) {
                const o = [...n.lineTools()]
                  ...
                  .map((e) => no(e.id(), e.instanceId()))
                ;(e[r.id()] = io(r.id(), 1, t.id(), o)), e[t.id()].children.push(r.id())
      ...
      var lo = n(36298),
        ...
        vo = n(57674),
        bo = n(46627)
      const yo = new lo.TranslatedString('show {title}', v.t(null, void 0, n(87358))),
        _o = new lo.TranslatedString('hide {title}', v.t(null, void 0, n(70301))),
        So = new lo.TranslatedString('lock {title}', v.t(null, void 0, n(50193))),
        wo = new lo.TranslatedString('unlock {title}', v.t(null, void 0, n(92421))),
        Co = new lo.TranslatedString('change {sourceTitle} title to {newSourceTitle}', v.t(null, void 0, n(40001))),
        To = new lo.TranslatedString('insert source(s) after', v.t(null, void 0, n(8343)))
      function Io(e, t) {
        return t.every((t) => !(t.pane() !== e && !t.allowsMovingbetweenPanes()))
      }
      function ko(e) {
        return e instanceof uo.DataSource && e.showInObjectTree() ? no(e.id(), e.instanceId()) : null
      }
      function Eo(e) {
      ...
      class No {
        constructor(e, t) {
          ;(this._syncStateChanged = new (eo())()),
            (this._lineToolsAffectChartInvalidation = new bo.FeatureToggleWatchedValue(Do, !1)),
        ...
        canBeLocked() {
          return (0, ao.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled()
        }
        canBeRemoved() {
        ...
        isActualInterval() {
          return (
            (!(0, ao.isLineTool)(this._dataSource) && !(0, co.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          )
        }
        onIsActualIntervalChange() {
          return (0, ao.isLineTool)(this._dataSource) || (0, co.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : Mo
        }
        isLocked() {
          return !!(0, ao.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value()
        }
        onVisibilityChanged() {
          return this._dataSource.properties().visible.listeners()
        }
        onLockChanged() {
          return (0, ao.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : Mo
        }
        getIcon() {
          const e = c,
            t = this._dataSource.getSourceIcon(),
            n = (0, co.isStudyStrategy)(this._dataSource)
          let o = { type: kn.Svg, content: n ? mo : fo }
          if (e && t)
            if ('loadSvg' === t.type) {
              const [n, r] = t.svgId.split('.'),
                s = 'linetool' === n ? e.linetool[r] : e.series[Number(r)]
              o = { type: kn.Svg, content: s || fo }
        ...
        setVisible(e) {
          const t = (e ? yo : _o).format({ title: Eo(this._dataSource) })
        ...
        setName(e) {
          if ((0, ao.isLineTool)(this._dataSource)) {
            const t = Co.format({
              sourceTitle: this._dataSource.properties().title.value() || Eo(this._dataSource),
              newSourceTitle: e,
            })
        ...
        canBeAddedToGroup() {
          return (0, ao.isLineTool)(this._dataSource) && this._dataSource.boundToSymbol()
        }
        ...
        canBeSyncedInLayout() {
          return (0, ao.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable()
        }
        onSyncStateChanged() {
        ...
        doNotAffectChartInvalidation() {
          return (0, ao.isLineTool)(this._dataSource) && this._lineToolsAffectChartInvalidation.value()
        }
        _canInsertBeforeOrAfter(e) {
          const t = this._undoModel.model()
          if (!Io(this.pane(), e)) return !1
          if ((0, ao.isLineTool)(this._dataSource)) {
            if (
          ...
          if ((0, ao.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, T.assert)(!e.some((e) => e.hasChildren())),
                s.forEach((e) => {
                  ;(0, ao.isLineTool)(e) && (t.containsLineTool(e) || o.addLineToolToGroup(t, e))
                }))
              : r()
          } else r()
      ...
      class xo {
        ...
        childrenIds() {
          ...
          return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map((e) => no(e.id(), e.instanceId())))
        }
        hasChildren() {
          return !0
        }
      ...
      class Lo {
        ...
        canBeGroupped(e) {
          ...
          const t = []
          if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, ao.isLineTool)(e) || !e.boundToSymbol())))
            return !1
          const n = this._undoModel.model(),
        ...
        _createObjectById(e) {
          ...
          if (null !== o) return new No(this._undoModel, o)
      ...
      const Uo = new lo.TranslatedString('move objects', v.t(null, void 0, n(40566))),
        Zo = new lo.TranslatedString('lock objects', v.t(null, void 0, n(68163))),
        Ko = new lo.TranslatedString('unlock objects', v.t(null, void 0, n(66824))),
        Yo = new lo.TranslatedString('show objects', v.t(null, void 0, n(63549))),
        $o = new lo.TranslatedString('hide objects', v.t(null, void 0, n(28506))),
        qo = new lo.TranslatedString('remove objects', v.t(null, void 0, n(57428)))
      class Jo {
        constructor(e) {
          ;(this._nodes = {}),
            (this._onChange = new (eo())()),
            ...
            (this._isContextMenuOpened = new (Oo())(!1)),
            ...
            (this._init = () => {
              ...
              e.hasModel() &&
                ...
                (this._groupModel = this._model.lineToolsGroupModel()),
                (this._facade = new Lo(this._controller)),
                (this._subscriptions = [
        ...
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities()
          return 1 === e.length && this.canNodeWithIdBeUnmerged(oo(e[0].id()).persistentId)
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e)
          return null !== t && (0, zo.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t)
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, T.ensureNotNull)(this._model.dataSourceForId(oo(e.id()).persistentId)))
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), dn('Copy', hn(e))
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, T.ensureNotNull)(this._model.dataSourceForId(oo(e.id()).persistentId)))
          t.every(ao.isLineTool) && (this._controller.cloneLineTools([...t], !1), dn('Clone', hn(e)))
        }
        rename(e, t) {
          const n = this._getObjectsToModify(e.id())
          1 === n.length && n.some((e) => e.canBeRenamed()) && (t(), dn('Rename', hn(n)))
        }
        async openContextMenu(e, t, n) {
          ...
          if (s.length > 0) {
            ...
            ;(a = i
              ...
              jo.ContextMenuManager.showMenu(s, n, { takeFocus: !0, returnFocus: !0 }, a, () => {
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          const i = (0, T.ensureDefined)(n.find((e) => e.id === r.parentId)).children
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const s = (0, go.createSyncDrawingActions)(this._chart.value(), o.filter(ao.isLineTool))
          s.length && (s.shift(), s.push(new Ro.Separator()), r.push(...s))
          const i = this._chart.value().actions().format.getState()
          return (
            r.push(
              new Ro.Action({
                actionId: 'ObjectsTree.ToggleItemLocked',
                label: e.isLocked() ? jn : Rn,
                icon: e.isLocked() ? Po : Bo,
                onExecute: () => this.setIsLocked(e.id(), !e.isLocked()),
              }),
              new Ro.Action({
                actionId: 'ObjectsTree.ToggleItemVisibility',
                label: e.isVisible() ? An : On,
                icon: e.isVisible() ? Fo : Wo,
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, T.ensureNotNull)(this._model.dataSourceForId(oo(n.id()).persistentId))
          if (!(0, zo.isPriceDataSource)(o)) throw new Error('Entity is not IPriceDataSource')
