  ...
  [2158, 8180, 2215],
  {
    ...
    95257: (t, e) => {
            ...
            g(s)
              ...
              : null != s &&
                (k(s) &&
                  ...
                  })(s, o + (!s.key || (a && a.key === s.key) ? '' : ('' + s.key).replace(T, '$&/') + '/') + t)),
                e.push(s)),
            1
          )
        if (((a = 0), (i = '' === i ? '.' : i + ':'), g(t)))
          ...
          for (t = f.call(t), c = 0; !(u = t.next()).done; ) a += C((u = u.value), e, o, (f = i + x(u, c++)), s)
        else if ('object' === u)
          throw (
            ((e = String(t)),
            Error(
      ...
      ;(e.Children = {
        ...
        (e.isValidElement = k),
        (e.lazy = function (t) {
          return { $$typeof: h, _payload: { _status: -1, _result: t }, _init: M }
        }),
        (e.memo = function (t, e) {
