      ...
      function u(e) {
        ...
        return n.createElement(
          K,
          {
            ...
            'aria-selected': u,
            'aria-checked': h,
            className: r(p, L.item, b && L.withIcon, { [L.isActive]: D, [L.isDisabled]: E || C, [L.hovered]: k }),
            title: m,
            href: N,
            target: y,
            rel: T,
            reference: function (e) {
              ;(H.current = e), 'function' == typeof B && B(e)
          ...
          void 0 !== b &&
            n.createElement('span', {
              ...
              className: r(L.icon, j && c['round-icon']),
              dangerouslySetInnerHTML: { __html: b },
            }),
          n.createElement(
            'span',
            { className: r(L.labelRow, f) },
            n.createElement('span', { className: r(L.label, v) }, x)
          ),
          (void 0 !== g || w) &&
            n.createElement('span', { className: L.shortcut }, (G = g) && G.split('+').join(' + ')),
          void 0 !== M &&
            n.createElement(
              'span',
              { onClick: A ? d : void 0, className: r(L.toolbox, { [L.showOnHover]: _, [L.showOnFocus]: O }) },
              M
            )
        )
        var G
    ...
    20520: (e, t, o) => {
      ...
      function h(e) {
        const {
          ...
          D = (0, n.useContext)(c.CloseDelegateContext),
          E = n.useContext(u),
          k = (0, n.useContext)(l),
      ...
      function l(e, t) {
        return (o, l) => {
          const d = (0, s.ensureNotNull)(e).getBoundingClientRect(),
            ...
            w = u === n.Top ? -1 * v : v,
            b = p === r.Right ? d.right : d.left,
            D = u === n.Top ? d.top : d.bottom,
            E = { x: b - (m === a.FromRightToLeft ? o : 0) + f, y: D - (h === i.FromBottomToTop ? l : 0) + w }
      ...
      const s = a,
        c = n.forwardRef((e, t) => {
          const {
            ...
            x = r(w, g.button, (v || k) && 'apply-common-tooltip', {
              [g.isActive]: c,
              [g.isOpened]: l,
              [g.isInteractive]: (b || Boolean(p)) && !d && !D,
              [g.isDisabled]: Boolean(d || D),
              [g.isGrouped]: u,
              [g.hover]: h,
            }),
            N =
              s &&
              ('string' == typeof s
                ? n.createElement(i.Icon, { className: g.icon, icon: s })
                : n.cloneElement(s, { className: r(g.icon, s.props.className) }))
          return 'button' === o
            ? n.createElement(
                'button',
                {
                ...
                f && m && n.createElement('div', { className: r('js-button-text', g.text) }, m),
                N,
                !f && m && n.createElement('div', { className: r('js-button-text', g.text) }, m)
              )
            : n.createElement(
      ...
      class f extends n.PureComponent {
        ...
        render() {
          const {
            ...
            b = r(p, f.button, { 'apply-common-tooltip': d || !a, [f.isDisabled]: a, [f.isOpened]: w })
          return 'button' === e
            ? n.createElement(
                'button',
                {
                ...
                o &&
                  n.createElement(
                    ...
                    n.createElement(
                      ...
                      n.createElement(s.ToolWidgetCaret, { dropped: w })
                    )
                  ),
                this.state.isOpened &&
                  (v
