;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5516, 9685],
  {
    ...
    70412: (e, t, a) => {
      'use strict'
      a.d(t, { hoverMouseEventFilter: () => o, useAccurateHover: () => s, useHover: () => i })
      var n = a(50959)
      function i() {
    ...
    26431: (e) => {
      e.exports = { button: 'button-HwLRKjG6', text: 'text-HwLRKjG6', logo: 'logo-HwLRKjG6' }
    },
    92710: (e) => {
      ...
      const r = (0, n.forwardRef)(function (e, t) {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            i,
            n.createElement(s.ToolWidgetCaret, { className: l.caret, dropped: Boolean(a) })
          ),
          a && r
        )
      })
    ...
    69297: (e, t, a) => {
      ...
      function h(e) {
        ...
        return i(a, r().switcher, r()[`size-${l}`], r()[`intent-${o}`], !h && r()['disable-active-state-styles'])
      }
      function c(e) {
        var t
        const {
      ...
      function p(e) {
        const {
          ...
          _ = o()(t, g.wrapper, a && g.wrapperWithOnLabel, l && g.wrapperWithDescription)
        return n.createElement(
          'label',
    ...
    6652: (e, t, a) => {
      ...
      const b = i.forwardRef((e, t) => {
        ...
        return i.createElement('div', { className: m(n, g.wrap), ref: t, ...o }, a)
      })
      var C = a(88066),
        S = a(52045)
      ...
      function R(e) {
        const { orientation: t, onKeyDown: a, ...n } = e,
          o = A.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'radiogroup', 'aria-orientation': t } : {}
        return i.createElement('div', {
          ...
          onKeyDown: (0, x.createSafeMulticastEventHandler)(function (e) {
            ...
            Array.from(i.querySelectorAll('[role="radio"]:not([disabled], [aria-disabled])')).filter(
              (0, A.createScopedVisibleElementFilter)(i)
            ...
            const s = () => {
                ...
                n[o].dispatchEvent(new CustomEvent('roving-tabindex:secondary-element')),
      ...
      class O extends i.PureComponent {
        constructor(e, t) {
          ...
          this.state = { activeStyle: i, favorites: s, styles: (0, k.commonChartStyles)(), japaneseStyles: l }
        }
        componentDidMount() {
        ...
        render() {
          const { isShownQuicks: e, displayMode: t = 'full', id: a } = this.props,
            { activeStyle: n, favorites: o, styles: s, japaneseStyles: l, lastSelectedNotFavorite: c } = this.state,
            u = 'small' !== t && e && 0 !== o.length,
            m = [...o]
          m.includes(n) ? void 0 !== c && m.push(c) : m.push(n)
          const p = u && m.length > 1
          return i.createElement(f.MatchMedia, { rule: w.DialogBreakpoints.TabletSmall }, (e) => {
            ...
            return i.createElement(
              ...
              i.createElement(
                ...
                {
                  arrow: Boolean(p),
                  content: p ? void 0 : i.createElement(b, null, i.createElement(d.Icon, { icon: h.SERIES_ICONS[n] })),
                  tooltip: p ? F.barsStyle : (0, T.getTranslatedChartStyleName)(n),
                  className: N.menu,
                  isDrawer: e,
      ...
      const B = ['medium', 'small'],
        W = (0, i.forwardRef)(function (e, t) {
          const { text: a, className: n, displayMode: o, collapseWhen: s = B, ...l } = e,
            r = !s.includes(o)
      ...
      class q extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (0, M.validateRegistry)(t, { chartWidgetCollection: o.any.isRequired }),
          ...
          e.forEach((e) => {
            switch (e.type) {
              ...
              case 'pine':
                ...
                break
              default:
                ;(0, te.assert)(!1, `unknown favorite type ${JSON.stringify(e)}`)
            }
          }),
          0 !== o.size &&
            a.push(
              t
                ...
                .then((e) => {
                  ...
                  if (0 !== t.notFoundItems.length) {
                    ...
                    ae.logWarn(`Cannot find java scripts: ${JSON.stringify(e)}`)
                  }
                  return t.items
                })
            ),
          Promise.all(a).then(
            (e) => (ae.logNormal('Requesting favorites info finished'), e.reduce((e, t) => e.concat(t), []))
          )
        )
      }
      var ie = a(29673),
      ...
      function re(e) {
        const { className: t } = e
        return i.createElement('div', { className: p()(le.spinnerWrap, t) }, i.createElement(se.Loader, null))
      }
      var he = a(82962),
        ce = a(76422),
        de = a(39681),
      ...
      class pe extends i.PureComponent {
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleSelectIndicator = (e) => {
              ;(e = (0, te.ensureDefined)(e)), this._trackFavoriteAction('Favorite indicator from toolbar')
              'java' === e.type ? e.studyId : e.pineId
              ;(() => {
                e = (0, te.ensureDefined)(e)
                const { chartWidgetCollection: t } = this.context
                if ('java' === e.type) {
                  const t = (0, ie.tryFindStudyLineToolNameByStudyId)(e.studyId)
            ...
            (0, M.validateRegistry)(t, { favoriteScriptsModel: o.any, chartWidgetCollection: o.any.isRequired })
        ...
        render() {
          const { isActive: e, favorites: t, favoriteFundamentals: n, isLoading: o } = this.state,
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              Boolean(t.length > 0 || (null == n ? void 0 : n.size)) &&
                i.createElement(f.MatchMedia, { rule: 'screen and (max-width: 430px)' }, (e) =>
                  i.createElement(
                    v.ToolbarMenuButton,
                    {
                          ...
                          this.state.infos.length > 0
                            ? this.state.infos.map((t) =>
                                i.createElement(u.PopupMenuItem, {
                                  ...
                                  theme: e ? E.multilineLabelWithIconAndToolboxTheme : void 0,
                            ...
                            : null !== this._promise &&
                                i.createElement(u.PopupMenuItem, { isDisabled: !0, label: s.t(null, void 0, a(23687)) })
                        )
                    )
                  )
                )
        ...
        _prefetchFavorites() {
          ...
          const n = (this._promise = Promise.all([ne(this.state.favorites, a), void 0]).then((e) => {
      ...
      function ge(e) {
        return e.info.localizedName || s.t(e.info.name, { context: 'study' }, a(68716))
      }
      pe.contextType = me
      var be = a(94025),
        Ce = a(20371)
      function Se(e) {
        return i.createElement('div', { className: m(Ce.value, { [Ce.selected]: e.isSelected }) }, e.value, e.metric)
      }
      var _e = a(65817),
        ye = a(67972)
      function fe(e) {
      ...
      function Me(e) {
        ...
        return i.createElement(u.PopupMenuItem, {
          ...a,
          className: p()(A.PLATFORM_ACCESSIBILITY_ENABLED && Ee.accessible, e.isActive && Ee.active, t),
          reference: n,
          tabIndex: o,
          onKeyDown: function (e) {
            if (!A.PLATFORM_ACCESSIBILITY_ENABLED || e.target !== e.currentTarget) return
            const t = (0, I.hashFromEvent)(e)
            ;(13 !== t && 32 !== t) || (e.preventDefault(), n.current instanceof HTMLElement && n.current.click())
          },
          'data-role': A.PLATFORM_ACCESSIBILITY_ENABLED ? 'menuitem' : void 0,
          'aria-disabled': (A.PLATFORM_ACCESSIBILITY_ENABLED && e.isDisabled) || void 0,
        })
      }
      class ke extends i.PureComponent {
        ...
        render() {
          ...
          return i.createElement(
            'div',
            { className: ye.form },
            i.createElement(we, { className: ye.input, maxLength: 7, onChange: this._handleChangeInput, value: e }),
            i.createElement(
              v.ToolbarMenuButton,
              {
                orientation: 'none',
            ...
            i.createElement(fe, { className: ye.add, onClick: this._handleClickAdd }, s.t(null, void 0, a(54777)))
          )
        }
      }
      var Te = a(90186),
      ...
      function Ne(e) {
        ...
        return A.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              'button',
              { ref: o, tabIndex: s, onClick: a, className: p()(Re.button, n.isActive && Re.active), type: 'button' },
      ...
      function He(e) {
        ...
        return A.PLATFORM_ACCESSIBILITY_ENABLED
          ? i.createElement(
              'button',
              { ref: o, tabIndex: s, onClick: a, className: p()(Fe.button, n.isActive && Fe.active), type: 'button' },
              i.createElement(c.FavoriteButton, { 'aria-label': t, ...n, 'data-tooltip': t })
            )
            ...
            i.createElement(Me, {
              ...
              toolbox: (function () {
                const { isRemovable: t, isFavoritingAllowed: a } = e,
                  ...
                  r = i.createElement(He, { key: 'favorite', isActive: n, isFilled: s, onClick: b })
                return [t && l, !o && a && r]
              })(),
      ...
      var De = a(36274)
      const Pe = {
        [De.ResolutionKind.Ticks]: s.t(null, { context: 'interval_group_name' }, a(30426)),
        [De.ResolutionKind.Seconds]: s.t(null, { context: 'interval_group_name' }, a(74973)),
        [De.ResolutionKind.Minutes]: s.t(null, { context: 'interval_group_name' }, a(57470)),
        [De.SpecialResolutionKind.Hours]: s.t(null, { context: 'interval_group_name' }, a(62346)),
        [De.ResolutionKind.Days]: s.t(null, { context: 'interval_group_name' }, a(74787)),
        [De.ResolutionKind.Weeks]: s.t(null, { context: 'interval_group_name' }, a(86614)),
        [De.ResolutionKind.Months]: s.t(null, { context: 'interval_group_name' }, a(94328)),
        [De.ResolutionKind.Range]: s.t(null, { context: 'interval_group_name' }, a(48801)),
      ...
      var qe = a(80022)
      const je = { openDialog: s.t(null, void 0, a(79353)), timeInterval: s.t(null, void 0, a(32916)) },
        Ge = (0, G.hotKeySerialize)({ keys: [','], text: s.t(null, void 0, a(14605)) }),
      ...
      class $e extends i.PureComponent {
            ...
            (this._handleRemoveInterval = (e, t) => {
              ...
              if (e) {
                if (
                  ...
                  const t = (0, v.queryMenuElements)(this._menuItemsContainerRef.current),
                    i = t.findIndex((t) => t.matches(`[data-value="${e}"]`))
                  if (-1 !== i) {
                    const e = null !== (a = t[i + 1]) && void 0 !== a ? a : t[i - 1]
                    e ? e.focus() : null === (n = this._menu.current) || void 0 === n || n.focusMenu()
                  }
                }
        ...
        render() {
          const { isShownQuicks: e, id: t } = this.props,
            { activeInterval: a, customs: n, lastNotQuicked: o, isAddIntervalDialogOpened: s } = this.state,
            l = this._getQuicks(),
          ...
          ;(void 0 !== a ? d.concat(a) : d).filter(be.isAvailable).forEach((e) => (c[e] = !0))
          const u = void 0 !== a ? (0, be.getTranslatedResolutionModel)(a) : null
          return i.createElement(
            b,
            { id: t },
            h &&
              i.createElement(
                ...
                r.map((e, t) => {
                  ...
                  return i.createElement(_, {
                    key: t,
                    role: 'radio',
                    className: m(qe.button, { [qe.first]: 0 === t, [qe.last]: t === r.length - 1 }),
            ...
            i.createElement(f.MatchMedia, { rule: w.DialogBreakpoints.TabletSmall }, (e) =>
              i.createElement(
                i.Fragment,
                null,
                i.createElement(
                  ...
                  i.createElement(
                    ...
                    i.createElement('div', { className: qe.dropdown }, this._renderChildren(d, e))
                  )
                ),
                e &&
                  s &&
      ...
      function et(e) {
        ...
        return i.createElement(
          'div',
          { key: 'add-dialog', className: m(qe.addCustomInterval, n), onClick: t },
      ...
      function gt(e) {
        ...
        return i.createElement(
          ...
          n
            ? i.createElement(se.Loader, { className: pt.loader, size: 'small', staticPosition: !0 })
      ...
      const _t = n.enabled('widget'),
        ...
        wt = (0, dt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { shortcut: Ct.shortcut, withIcon: Ct.withIcon }),
      ...
      class xt extends i.PureComponent {
        ...
        render() {
          const {
            ...
            S = i.createElement(
              ...
              i.createElement('span', { className: Ct.text }, l || s.t(null, void 0, a(85520))),
            ...
            t
              ...
              : i.createElement(
                  ...
                  i.createElement(z, {
                    ...
                    theme: ft,
                    collapseWhen: kt,
                    tooltip: C ? s.t(null, void 0, a(88368)) : s.t(null, void 0, a(87409)),
        ...
        _renderMenuItems(e) {
          ...
          return (
            ...
            T.push(
              i.createElement(y.PopupMenuSeparator, { key: 'all-layouts-separator' }),
              i.createElement(u.PopupMenuItem, {
                key: 'all-layouts',
      ...
      class At extends i.PureComponent {
        ...
        componentDidMount() {
          ...
          t
            ...
            : (o.getOnChange().subscribe(this, this._onChangeHasChanges),
              ...
              this._hotkeys.add({ desc: s.t(null, void 0, a(75687)), handler: this._handleHotkey, hotkey: 190 }),
        ...
        render() {
          ...
          return i.createElement(f.MatchMedia, { rule: w.DialogBreakpoints.TabletSmall }, (e) =>
            i.createElement(xt, { ...v, isTabletSmall: e })
          )
        }
        _onLoginStateChange() {
      ...
      function zt(e) {
        ...
        return i.createElement(
          ...
          i.createElement('span', { className: a }, i.createElement(se.Loader, null))
        )
      }
      var Vt = a(76974),
        Zt = a(84502),
      ...
      function Xt(e) {
        const { serverSnapshot: t, clientSnapshot: n, hideShortcuts: o } = e,
          ...
          g = (0, i.useCallback)(async () => {
            ...
            try {
              await (0, Ut.writePromiseUsingApi)(a, 'image/png'), ce.emit('onClientScreenshotCopiedToClipboard')
            } catch (a) {
            ...
            async (e = !1) => {
              ...
              try {
                if (e) await C(a)
                  ...
                  await (0, Ut.writePromiseUsingApi)(e, 'text/plain'), ce.emit('onServerScreenshotCopiedToClipboard')
                }
                return !0
              } catch (e) {
                return C(a), !0
          ...
          _ = (0, i.useCallback)(async () => {
            ...
            e.Twitter.shareSnapshotInstantly(n.symbol, n.imageUrl), p.current && (v(!1), (0, Ve.globalCloseMenu)())
          }, [t])
        return i.createElement(
          i.Fragment,
          null,
          i.createElement(he.ToolWidgetMenuSummary, null, s.t(null, void 0, a(45888))),
          i.createElement(u.PopupMenuItem, {
            'data-name': 'save-chart-image',
            label: s.t(null, void 0, a(39011)),
            icon: Qt,
            onClick: b,
            shortcut: o ? void 0 : (0, Y.humanReadableHash)(Y.Modifiers.Mod + Y.Modifiers.Alt + 83),
            theme: Yt,
          }),
          i.createElement(u.PopupMenuItem, {
            ...
            icon: Kt,
            onClick: g,
            shortcut: o ? void 0 : (0, Y.humanReadableHash)(Y.Modifiers.Mod + Y.Modifiers.Shift + 83),
            theme: Yt,
          }),
          i.createElement(u.PopupMenuItem, {
            'data-name': 'copy-link-to-the-chart-image',
            label: i.createElement(zt, { isLoading: l }, s.t(null, void 0, a(7367))),
            icon: qt,
            onClick: () => {
              r(!0), S(!1)
            },
            dontClosePopup: !0,
            isDisabled: l,
            shortcut: o ? void 0 : (0, Y.humanReadableHash)(Y.Modifiers.Alt + 83),
            className: m(l && Gt.loading),
            theme: Yt,
          }),
          i.createElement(u.PopupMenuItem, {
            'data-name': 'open-image-in-new-tab',
            label: i.createElement(zt, { isLoading: h }, s.t(null, void 0, a(38543))),
            icon: jt,
            onClick: () => {
              c(!0), S(!0)
            },
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            label: i.createElement(zt, { isLoading: d }, s.t(null, void 0, a(99746))),
            icon: Zt,
            onClick: _,
            dontClosePopup: !0,
            isDisabled: d,
      ...
      class la {
        async show(e) {
          ...
          if (la._currentShowingInstance) throw new DOMException('SymbolSearchUI is already shown', 'InvalidStateError')
          try {
      ...
      ;(la._currentShowingInstance = null), (la._provider = null), (la._implementation = null)
      var ra = a(25882),
        ha = a(26431)
      ...
      class da extends i.PureComponent {
        constructor(e) {
          super(e),
                  ...
                  ;(0, V.trackEvent)('GUI', 'SS', 'main search'),
                    await new la().show({
                      ...
                      footer: Ie.mobiletouch
                        ? void 0
                        : i.createElement(oa.SymbolSearchDialogFooter, null, s.t(null, void 0, a(20987))),
                    })
                } catch (e) {}
            ...
            (this.state = { symbol: l.linking.symbol.value(), shortName: ua() })
        }
        componentDidMount() {
        ...
        render() {
          ...
          return i.createElement(C.ToolbarButton, {
            id: e,
            className: p()(t, n.enabled('uppercase_instrument_names') && ra.uppercase, ra.largeLeftPadding),
            theme: ca,
            icon: void 0,
      ...
      function ma(e) {
        ...
        return A.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          : i.createElement(
              'div',
              { className: m(a, va.item, 'apply-common-tooltip'), onClick: r, 'data-tooltip': n.name },
              i.createElement('div', { className: va.round }, n.name.length > 0 ? n.name[0].toUpperCase() : ' ')
            )
        function r(e) {
      ...
      var pa = a(39344),
        ga = a(92710)
      function ba(e) {
        return i.createElement('div', { className: m(ga.description, e.className) }, e.children)
      }
      var Ca = a(48261)
      const Sa = (0, dt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, {
        ...
        ya = (0, dt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { item: Ca.item }),
        fa = (0, dt.mergeThemes)(u.DEFAULT_POPUP_MENU_ITEM_THEME, { item: Ca.itemTabletSmall })
      function wa(e) {
        const {
            className: t,
            item: a,
        ...
        return i.createElement(
          ...
          i.createElement(u.PopupMenuItem, {
            ...
            toolbox: i.createElement(
              i.Fragment,
              null,
              !a.is_default && i.createElement(Ae.RemoveButton, { key: 'remove', hidden: !Ie.touch && !d, onClick: _ }),
              Boolean(s) &&
                r &&
                i.createElement(c.FavoriteButton, { key: 'favorite', isFilled: Boolean(l), onClick: y })
            ),
          }),
          g &&
            i.createElement(u.PopupMenuItem, {
              theme: C,
              label: i.createElement(ba, { className: p()(Ca.description, h && Ca.descriptionTabletSmall) }, g),
              onClick: S,
              isHovered: d,
            })
        )
        ...
        return i.createElement(u.PopupMenuItem, {
          ...
          label: i.createElement(
            ...
            i.createElement(
              ...
              i.createElement('div', { className: Ma.text }, (0, mt.appendEllipsis)(s.t(null, void 0, a(92093))))
            )
          ),
          onClick: t,
        })
      ...
      function Na(e) {
        ...
        return i.createElement(
          ...
          h &&
            i.createElement(i.Fragment, null, i.createElement(y.PopupMenuSeparator, null), i.createElement(re, null)),
          !h &&
            (r
              ? i.createElement(Fa, { defaults: c, customs: d, render: b })
              : i.createElement(Ha, { defaults: c, customs: d, render: b, state: v }))
        )
      }
      function Fa(e) {
        ...
        return i.createElement(
          ...
          n.length > 0 &&
            i.createElement(
              ...
              null,
              i.createElement(y.PopupMenuSeparator, null),
              i.createElement(he.ToolWidgetMenuSummary, { className: Ra.menuItemHeader }, s.t(null, void 0, a(38554))),
              n.map(o)
            ),
          n.length > 0 &&
            t.length > 0 &&
          ...
          0 === n.length &&
            ...
            i.createElement(
              ...
              null,
              i.createElement(y.PopupMenuSeparator, null),
              i.createElement(he.ToolWidgetMenuSummary, { className: Ra.menuItemHeader }, s.t(null, void 0, a(43399))),
              t.map(o)
            )
        )
      }
      ...
      class Da {
        constructor(e, t) {
          ...
          ;(this._state = new (Oa())({ isLoading: !1, studyTemplatesList: s, favorites: o })),
      ...
      class Wa extends i.PureComponent {
        constructor(e, t) {
          ...
          ;(this._model = new Da(n, a)), (this.state = { ...this._model.state().value(), isActive: !1 })
        }
        componentDidMount() {
        ...
        render() {
          const { studyTemplatesList: e, favorites: t } = this.state,
            { isShownQuicks: a, className: n, displayMode: o, id: s } = this.props
          return i.createElement(
            Aa.Provider,
      ...
      function za(e) {
        const {
          ...
          g = p()(n, Ua.wrap, { [Ua.full]: 'full' === o, [Ua.medium]: 'medium' === o }),
          C = r.filter((e) => l.includes(e.name)),
          S = 'small' !== o && u && C.length > 0
        return i.createElement(
          b,
          { id: t, className: g },
          i.createElement(f.MatchMedia, { rule: w.DialogBreakpoints.TabletSmall }, (t) =>
            i.createElement(
              v.ToolbarMenuButton,
              {
                onOpen: e.onMenuOpen,
        ...
        return i.createElement(
          ...
          e.favorites.map((t, a, n) =>
            i.createElement(ma, {
              ...
              className: p()({ [Ua.first]: 0 === a, [Ua.last]: a === n.length - 1 }),
            })
          )
        )
      }
      ...
      class Ya extends i.PureComponent {
        ...
        render() {
          const { id: e } = this.props,
            { isEnabledRedo: t, isEnabledUndo: n, redoStack: o, undoStack: l } = this.state
          return i.createElement(
            b,
            { id: e },
            i.createElement(C.ToolbarButton, {
              ...
              theme: ja,
              tooltip: n ? s.t(null, { replace: { hint: l } }, a(80323)) : void 0,
            ...
            i.createElement(C.ToolbarButton, {
              ...
              theme: ja,
              tooltip: t ? s.t(null, { replace: { hint: o } }, a(70728)) : void 0,
      ...
      function tn() {
        return {
          ...
          OpenPopup: ot,
          Properties: n.enabled('header_settings') && n.enabled('show_chart_property_page') ? rt : void 0,
    ...
    39344: (e, t, a) => {
      'use strict'
      a.d(t, { createStudyTemplateMetaInfo: () => i, descriptionString: () => o })
      var n = a(28853)
      function i(e, t) {
        return {
          indicators: e
    ...
    45876: (e, t, a) => {
      ...
      var n = a(94670),
        ...
        v = a(71705),
        m = a(9450)
      const p = { 3: n, 16: i, 0: o, 1: s, 8: l, 9: r, 2: h, 14: c, 15: d, 10: u, 12: v, 13: m }
    },
    53166: (e, t, a) => {
      'use strict'
