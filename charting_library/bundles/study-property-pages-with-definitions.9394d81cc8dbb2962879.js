  ...
  [607],
  {
    41109: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        s = i(94474),
        o = i(99970)
      const d = new r.TranslatedString('change {title} base line visibility', n.t(null, void 0, i(16688))),
        c = new r.TranslatedString('change {title} base line color', n.t(null, void 0, i(97029))),
        u = new r.TranslatedString('change {title} base line width', n.t(null, void 0, i(51676))),
        h = new r.TranslatedString('change {title} base line style', n.t(null, void 0, i(3868))),
        p = new r.TranslatedString('change {title} up line visibility', n.t(null, void 0, i(17564))),
        y = new r.TranslatedString('change {title} up line color', n.t(null, void 0, i(25253))),
        g = new r.TranslatedString('change {title} up line width', n.t(null, void 0, i(66118))),
        b = new r.TranslatedString('change {title} up line style', n.t(null, void 0, i(58003))),
        _ = new r.TranslatedString('change {title} down line visibility', n.t(null, void 0, i(23527))),
        m = new r.TranslatedString('change {title} down line color', n.t(null, void 0, i(15438))),
        v = new r.TranslatedString('change {title} down line width', n.t(null, void 0, i(44470))),
        f = new r.TranslatedString('change {title} down line style', n.t(null, void 0, i(3782))),
        w = new r.TranslatedString('change {title} extend lines', n.t(null, void 0, i(96902))),
        k = new r.TranslatedString("change {title} show pearson's r", n.t(null, void 0, i(38317))),
      ...
      class T extends l.StudyLineDataSourceDefinitionsViewModel {
        constructor(e, t) {
          super(e, t)
        }
        _stylePropertyDefinitions() {
            ...
            T = (0, a.createLinePropertyDefinition)(
              {
                ...
                width: (0, a.convertToDefinitionProperty)(this._propertyApplier, l.linewidth, u.format({ title: n })),
                style: (0, a.convertToDefinitionProperty)(this._propertyApplier, l.linestyle, h.format({ title: n })),
              },
              { id: `${i}BaseLine`, title: S }
            ),
            L = e.upLine.childs(),
            M = (0, a.createLinePropertyDefinition)(
              {
                checked: (0, a.convertToDefinitionProperty)(
                  this._propertyApplier,
                  new o.StudyPlotVisibleProperty(L.display),
                ...
                width: (0, a.convertToDefinitionProperty)(this._propertyApplier, L.linewidth, g.format({ title: n })),
                style: (0, a.convertToDefinitionProperty)(this._propertyApplier, L.linestyle, b.format({ title: n })),
              },
              { id: `${i}UpLine`, title: P }
            ),
            N = e.downLine.childs()
          return {
            definitions: [
              T,
              M,
              (0, a.createLinePropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(
                    this._propertyApplier,
                    new o.StudyPlotVisibleProperty(N.display),
                    _.format({ title: n })
                  ),
                  color: (0, a.getColorDefinitionProperty)(
                    this._propertyApplier,
                  ...
                  width: (0, a.convertToDefinitionProperty)(this._propertyApplier, N.linewidth, v.format({ title: n })),
                  style: (0, a.convertToDefinitionProperty)(this._propertyApplier, N.linestyle, f.format({ title: n })),
                },
    ...
    56059: (e, t, i) => {
      ...
      class u extends s.LineDataSourceDefinitionsViewModel {
        ...
        _inputsPropertyDefinitions() {
          return {
            definitions: [
              (0, l.createStudyInputsPropertyDefinition)(
                {},
                {
                  id: 'StudyInputs',
                  inputs: new o.MetaInfoHelper(this._source.metaInfo()).getUserEditableInputs(),
                  inputsTabProperty: this._source.properties(),
                  model: this._undoModel,
                  studyMetaInfo: this._source.metaInfo(),
                  source: {
                    isInputsStudy: !0,
                    symbolsResolved: () => new (a())(),
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return (
            e.forEach((e, a) => {
              ...
              r.push(
                (0, l.createCoordinatesPropertyDefinition)(
                  { x: o.property },
                  {
                    id: (0, c.removeSpaces)(`${this._source.name()}Point${a}`),
                    title: n.t(null, { context: 'linetool point' }, i(63227)).format({ count: (a + 1).toString() }),
                    ...o.info,
                  }
                )
              )
    ...
    89204: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        u = i.n(c),
        h = i(94474)
      const p = new r.TranslatedString('change {inputName} property', n.t(null, void 0, i(21547)))
      function y(e, t) {
        const i = e.id
        return (
      ...
      const w = n.t(null, void 0, i(32733)),
        ...
        P = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map((e) => ({
          value: e,
          title: (0, v.getTranslatedResolutionModel)(e).hint,
        }))
      var z = i(32766),
        I = i(42960)
      const D = new r.TranslatedString('change study overlay style', n.t(null, void 0, i(5529))),
        T = new r.TranslatedString('change price line visibility', n.t(null, void 0, i(67761))),
        L = new r.TranslatedString('change study overlay min tick', n.t(null, void 0, i(70016))),
        M = n.t(null, void 0, i(16812)),
        N = n.t(null, void 0, i(63528)),
        j = n.t(null, void 0, i(61582)),
        x = n.t(null, void 0, i(36018)),
        Y = n.t(null, void 0, i(1277)),
        A = n.t(null, void 0, i(42097)),
        U = n.t(null, void 0, i(34911)),
        E = n.t(null, void 0, i(17712)),
        C = n.t(null, void 0, i(31994)),
        W = n.t(null, void 0, i(38397)),
      ...
      a.enabled('chart_style_hilo') && X.push({ title: C, value: 12 })
      class O extends class {
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, o.createPropertyPage)(
            (0, f.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._undoModel,
              e,
              new r.TranslatedString(this._source.name(!0), this._source.title(!0))
            ),
            'visibility',
            S
          )
        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput && (this._inputSourceItems = new (u())(this._getInputSourceItems())),
            (function (e, t, a, o, d) {
              const c = []
              for (const h of t) {
                if (!y(h, o)) continue
                const t = g(h),
                  _ = `StudyInput${h.id}`,
                  m = b(t),
                  v = new r.TranslatedString(t, m)
                let f = null
                if ('resolution' === h.type)
                  f = (0, s.createOptionsPropertyDefinition)(
                    { option: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
                    { id: _, title: m, options: new (u())(d.resolutionItems) }
                  )
                else if ('source' === h.type) {
                  const t = (0, l.ensure)(d.sourcesItems)
                  f = (0, s.createOptionsPropertyDefinition)(
                    { option: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
                  ...
                  for (const e of h.options) {
                    const r = (h.optionsTitles && h.optionsTitles[e]) || e,
                      a = n.t(r, { context: 'input' }, i(88601))
                    t.push({ value: e, title: a })
                  }
                  f = (0, s.createOptionsPropertyDefinition)(
                    { option: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
                    { id: _, title: m, options: new (u())(t) }
                  )
                } else if ('symbol' === h.type) {
                  const t = a[h.id],
                    i = (0, l.ensure)(d.getSymbolInfoBySymbol),
                    n = (0, l.ensure)(d.onSymbolsInfosChanged)
                  ...
                  f = (0, s.createSessionPropertyDefinition)(
                    { session: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
                    { id: _, title: m }
                  )
                else if ('bool' === h.type)
                  f = (0, s.createCheckablePropertyDefinition)(
                    { checked: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
                    { id: _, title: m }
                  )
                  ...
                  void 0 !== h.min && (t.min = new (u())(h.min)),
                    ...
                    void 0 !== h.step && isFinite(h.step) && h.step > 0 && (t.step = new (u())(h.step)),
                    (f = (0, s.createNumberPropertyDefinition)(
                      { value: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
                      t
                    ))
                } else
                  f = (0, s.createTextPropertyDefinition)(
                    { text: (0, s.convertToDefinitionProperty)(e, a[h.id], p.format({ inputName: v })) },
        ...
        _getInputSourceItems() {
          const e = _.basePriceSources.slice(),
            t = (0, l.ensureNotNull)(this._sourceInput)
          if (this._source && this._source.isChildStudy()) {
            const i = this._source.inputs()[t.id],
              n = (0, l.ensureNotNull)(this._source.parentSourceForInput(i.v)),
              r = n.title(),
              a = m.StudyMetaInfo.getChildSourceInputTitles(t, n.metaInfo(), r)
            for (const t of Object.keys(a)) e.push({ id: t, value: t, title: a[t] })
          }
          if (
            a.enabled('study_on_study') &&
            this._source &&
            (this._source.isChildStudy() || m.StudyMetaInfo.canBeChild(this._source.metaInfo()))
          ) {
            ...
            this._undoModel
              ...
              .forEach((t) => {
                ...
                if (1 === s.length) e.push({ id: n, value: n, title: i })
                  ...
                  const t = s.reduce((e, t, r) => {
                    if (!m.StudyMetaInfo.canPlotBeSourceOfChildStudy(t.type)) return e
                    let s
                    try {
                      s = (0, l.ensureDefined)((0, l.ensureDefined)(a)[t.id]).title
                    } catch (e) {
                      s = t.id
                    }
                    return { ...e, [`${n}$${r}`]: `${i}: ${s}` }
        ...
        _stylePropertyDefinitions() {
          ...
          const e = this._source.properties().childs(),
            ...
            n = (0, s.createOptionsPropertyDefinition)(
              ...
              { id: 'StudyOverlayMinTick', title: V, options: new (u())((0, _.seriesPrecisionValues)()) }
            ),
            r = (0, h.removeSpaces)(this._source.title())
          return {
            definitions: [
        ...
        _getSeriesStylesDefinitions() {
          ...
          return (0, z.getSeriesStylePropertiesDefinitions)(
            ...
            e,
            t,
            { seriesPriceSources: _.basePriceSources, isJapaneseChartsAvailable: !1 },
            'mainSeries'
          )
        }
        _availableStyles() {
    ...
    99970: (e, t, i) => {
      'use strict'
      i.d(t, { StudyPlotVisibleProperty: () => a })
      var n = i(57898),
        r = i.n(n)
      class a {
        constructor(e) {
    ...
    18567: (e) => {
      e.exports = {
        ...
        tr: ['{propertyName} özelliğini dğş'],
