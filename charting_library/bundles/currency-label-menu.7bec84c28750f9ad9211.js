;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('div', { className: a()(n ? C.textWrap : C.ellipsis) }, t),
              o && r.createElement('div', { className: a()(C.ellipsis, C.subtitle) }, o)
            ),
            u,
            i &&
              !E &&
              r.createElement(
                ...
                r.createElement(v.Icon, { className: C.icon, icon: y, 'data-name': 'close', 'data-role': 'button' })
              )
          )
        )
      }
      ...
      class k extends r.PureComponent {
        ...
        componentDidMount() {
          ...
          this.props.ignoreClosePopupsAndDialog ||
            m.subscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t
          this.props.ignoreClosePopupsAndDialog ||
            m.unsubscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
          ...
          return r.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.SmallHeight }, (m) =>
            r.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, (d) =>
              r.createElement(
                ...
                r.createElement(
                  'div',
                  { className: a()(b.wrapper, t), 'data-name': l, 'data-dialog-name': $ },
                  void 0 !== i &&
                    r.createElement(E, {
                      draggable: A && !(d || N),
                  ...
                  k && r.createElement(u.Separator, { className: b.separator }),
                  r.createElement(p.PopupContext.Consumer, null, (e) => this._renderChildren(e, d || N))
                )
              )
            )
          )
    ...
    71834: (e, t, n) => {
      ...
      function _(e) {
        var t, n
        const o = ((i = e.size), (a = e.className), d('tv-circle-logo', `tv-circle-logo--${i}`, a))
        var i, a
        const s = null !== (n = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== n ? n : ''
        return (function (e) {
          return 'logoUrl' in e && void 0 !== e.logoUrl && 0 !== e.logoUrl.length
        })(e)
          ? r.createElement('img', { className: o, src: e.logoUrl, alt: s, title: e.title, loading: e.loading })
          : r.createElement('span', { className: o, title: e.title }, e.placeholderLetter)
      }
      var b = n(24637),
        w = n(55002)
      const x = r.memo(
        function (e) {
          ...
          return r.createElement(
            'div',
            { className: h()(w.action, c && w.active, C, f && w.withDescription, d && w.selected), onClick: y, ref: p },
            m &&
              (void 0 !== n
                ? r.createElement(_, { logoUrl: n, size: f ? 'xsmall' : 'xxxsmall', className: h()(w.icon, C) })
            ...
            r.createElement(
              ...
              f && r.createElement('span', { className: h()(w.description, C) }, a ? x(a) : '')
            ),
            void 0 !== v &&
              r.createElement(
                'div',
      ...
      function I(e) {
        const {
          ...
          [b, w] = (0, r.useState)(() => o.reduce((e, t, n) => (t.name && (e[t.id] = !0), e), {}))
        function N(e) {
          const { id: t, ...n } = e
        ...
        return r.createElement(R.AdaptivePopupDialog, {
          ...
          render: function () {
            return r.createElement(
              r.Fragment,
              null,
              r.createElement(M.DialogSearch, { placeholder: p.t(null, void 0, n(52298)), onChange: v, reference: h }),
              r.createElement(
                'div',
                ...
                l
                  ...
                  : i.map((e, t) =>
                      r.createElement(
                        r.Fragment,
                        { key: e.id },
                        e.name && r.createElement('div', { className: L.section }, e.name),
                        e.actions.map((n, c) => {
                          const { id: u, ...h } = n,
                          ...
                          return r.createElement(
                            ...
                            !v && p && r.createElement('div', { className: L.separator })
                          )
                        })
                      )
                    )
      ...
      function z(e) {
        ...
        return r.createElement(a.MatchMedia, { rule: c.DialogBreakpoints.TabletSmall }, (e) =>
          e
            ? r.createElement(T, { ...n, ...y })
            : r.createElement(I, { ...n, ...y, position: (0, u.getPopupPositioner)(t, B), doNotCloseOn: t })
        )
        function C() {
    ...
    19785: (e, t, n) => {
      'use strict'
      n.d(t, { createRegExpList: () => i, getHighlightedChars: () => a, rankedSearch: () => o })
      var r = n(1722)
      function o(e) {
        const {
          data: t,
            ...
            return (
              n.forEach((e) => {
                ...
                if ((0, r.isString)(i) && f.test(i))
                  return (h = 2), void (d = null === (s = i.match(f)) || void 0 === s ? void 0 : s.index)
    ...
    24637: (e, t, n) => {
      ...
      function s(e) {
        const { queryString: t, rules: n, text: s, className: l } = e,
          c = (0, r.useMemo)(() => (0, i.getHighlightedChars)(t, s, n), [t, n, s])
        return r.createElement(
          r.Fragment,
          null,
          c.length
            ? s
                ...
                .map((e, t) =>
                  r.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? r.createElement('span', { className: o(a.highlighted, l) }, e)
    ...
    95257: (e, t) => {
      ...
      function k(e, t, r) {
        ...
        return { $$typeof: n, type: e, key: a, ref: s, props: i, _owner: w.current }
      }
      function S(e) {
            ...
            _(a)
              ...
              : null != a &&
                (S(a) &&
                  ...
                  })(a, o + (!a.key || (l && l.key === a.key) ? '' : ('' + a.key).replace(A, '$&/') + '/') + e)),
                t.push(a)),
            1
          )
        if (((l = 0), (i = '' === i ? '.' : i + ':'), _(e)))
          ...
          for (e = u.call(e), c = 0; !(s = e.next()).done; ) l += D((s = s.value), t, o, (u = i + N(s, c++)), a)
        else if ('object' === s)
          throw (
            ((t = String(e)),
            Error(
      ...
      var M = { current: null },
        L = { transition: null },
        T = { ReactCurrentDispatcher: M, ReactCurrentBatchConfig: L, ReactCurrentOwner: w }
      ;(t.Children = {
        map: I,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            ...
            for (c in t) b.call(t, c) && !x.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== l ? l[c] : t[c])
          }
      ...
      const l = (0, r.forwardRef)(function (e, t) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            o,
            r.createElement(a.ToolWidgetCaret, { className: s.caret, dropped: Boolean(n) })
          ),
          n && l
        )
      })
      ...
      function c(e, t) {
        return (n, c) => {
          const u = (0, s.ensureNotNull)(e).getBoundingClientRect(),
            ...
            _ = { x: C - (f === a.FromRightToLeft ? n : 0) + m, y: E - (h === i.FromBottomToTop ? c : 0) + y }
    ...
    84298: (e, t, n) => {
      ...
      function s(e, t, s) {
        ...
        return (E.length > 0 || C.length > 0) && l.push({ id: 'second_section', actions: C.concat(E) }), l
      }
    },
    79188: (e, t, n) => {
      'use strict'
    ...
    14818: (e, t, n) => {
      ...
      function s(e, t, s) {
        ...
        ;(y.length > 0 || C.length > 0) &&
          m.actions.push(...C.sort((e, t) => e.label.toLowerCase().localeCompare(t.label.toLowerCase())), ...y),
          m.actions.length > 0 && l.push(m)
    ...
    89691: (e, t, n) => {
      ...
      function r(e, t, n, r, o, i, a, s) {
        return { id: e, label: t, icon: n, description: r, isActive: o, onClick: i, isFavorite: a, onFavoriteClick: s }
      }
