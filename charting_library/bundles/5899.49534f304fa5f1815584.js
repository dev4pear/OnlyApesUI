;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5899],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (n) {
              ...
              if ('string' === s || 'number' === s) e.push(n)
                ...
                a && e.push(a)
              } else if ('object' === s) for (var i in n) r.call(n, i) && n[i] && e.push(i)
            }
          }
          return e.join(' ')
        }
    ...
    29332: (e, t, n) => {
      'use strict'
      n.d(t, { ContextMenu: () => g, OverlapContextMenu: () => w })
      var r = n(50959),
        o = n(97754),
        s = n.n(o),
        a = n(86431),
          ...
          r.createElement(
            ...
            l &&
              r.createElement(
                v.Drawer,
                { onClose: c },
                r.createElement(k, { items: n.subItems, parentAction: t, closeNested: c })
              )
          )
        )
        function c(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            t.map((e) => {
              switch (e.type) {
                case 'action':
                  return r.createElement(y, { key: e.id, action: e })
                case 'separator':
      ...
      function m(e) {
        ...
        return o
          ...
          : r.createElement(
              ...
              r.createElement('span', { className: s()(d.label) }, null != I ? I : C),
              !!S &&
                r.createElement(a.Icon, {
                  onClick: function () {
                    S && S.action()
              ...
              !O && k && r.createElement(c.Hint, { className: d.shortcut, text: k }),
    ...
    95257: (e, t) => {
      ...
      var E = (_.prototype = new y())
      ;(E.constructor = _), f(E, b.prototype), (E.isPureReactComponent = !0)
      var k = Array.isArray,
      ...
      function w(e, t, r) {
        ...
        if (null != t)
          for (o in (void 0 !== t.ref && (i = t.ref), void 0 !== t.key && (a = '' + t.key), t))
            x.call(t, o) && !g.hasOwnProperty(o) && (s[o] = t[o])
        ...
        return { $$typeof: n, type: e, key: a, ref: i, props: s, _owner: C.current }
      }
      function S(e) {
      ...
      var D = { current: null },
        L = { transition: null },
        G = { ReactCurrentDispatcher: D, ReactCurrentBatchConfig: L, ReactCurrentOwner: C }
      ;(t.Children = {
        map: O,
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (null != t) {
            ...
            for (c in t) x.call(t, c) && !g.hasOwnProperty(c) && (o[c] = void 0 === t[c] && void 0 !== l ? l[c] : t[c])
          }
    ...
    58451: (e, t, n) => {
      ...
      class N extends r.PureComponent {
          ...
          super(e),
            ...
            (this._handleClick = (e) => {
              e.isDefaultPrevented() ||
                ...
                (this._hasSubItems()
                  ? this._showSubMenu()
                  : (this.state.doNotCloseOnClick || (0, k.globalCloseMenu)(),
              ...
              (function (e, t, n = { x: 0, y: 10 }) {
                if (t) {
                  const { left: n, right: r, top: o } = t.getBoundingClientRect(),
                    ...
                    a = { x: n - e, y: o },
                    i = { x: r, y: o }
                  return (0, C.isRtl)() ? (n <= e ? i : a) : s - r >= e ? i : a
                }
                return n
              })(e, this._itemRef)),
            (this._updateState = (e) => {
        ...
        _trackEvent() {
          ...
          ;(0, x.trackEvent)('ContextMenuClick', this.props.menuStatName || '', e)
        }
        _getStatName() {
          return [this.props.parentStatName, this.state.statName].filter((e) => Boolean(e)).join('.')
        }
      }
      N.contextType = g.SubmenuContext
