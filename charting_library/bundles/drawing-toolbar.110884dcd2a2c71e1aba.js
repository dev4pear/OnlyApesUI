  ...
  [2878],
  {
    ...
    27267: (e, t, o) => {
      ...
      function n(e, t, o, n, i) {
        function a(i) {
          ...
          const a = i.target
          void 0 !== o && null !== t && null !== a && a.ownerDocument === n && (t.contains(a) || o(i))
        }
        return (
    ...
    67842: (e, t, o) => {
      ...
      function r(e, t = []) {
        ...
        const u = (0, l.useFunctionalRefObject)(r),
          d = (0, n.useCallback)(
            (e) => {
              u(e), null !== s.current && (s.current.disconnect(), null !== e && s.current.observe(e))
            },
            [u, s]
          )
        return (
    ...
    41590: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        d = o(66076)
      function h(e) {
        const { position: t = 'Bottom', onClose: o, children: u, className: h, theme: v = d } = e,
        ...
        return (
          ...
          n.createElement(
            ...
            n.createElement(
              ...
              g === p.currentDrawer && n.createElement('div', { className: d.backdrop, onClick: o }),
              n.createElement(
                m,
                { className: a(v.drawer, d[`position${t}`], h), ref: b, 'data-name': e['data-name'] },
                u
              )
            )
          )
      ...
      const m = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(u.TouchScrollContainer, { className: a(d.drawer, o), tabIndex: -1, ref: t, ...i })
      })
    },
    173: (e, t, o) => {
      'use strict'
    ...
    47291: (e, t, o) => {
      ...
      function m(e) {
        ...
        const p = (0, n.useCallback)((e) => ('title' === a[e].type ? 30 : l), [a, l]),
          g = (0, n.useCallback)(
            ({ visibleStartIndex: e }) => {
        ...
        return n.createElement(
          h.Provider,
          { value: (0, n.useMemo)(() => ({ size: l, onSelect: r, ItemComponent: c, RowComponent: u }), [l, r, c, u]) },
      ...
      const v = n.memo((e) => {
        const { style: t, index: o, data: i } = e,
          a = i[o],
          { size: l, onSelect: r, ItemComponent: d, RowComponent: m = c.EmojisRow } = (0, u.useEnsuredContext)(h)
        return 'title' === a.type
          ? n.createElement('div', { style: t }, n.createElement(s, { title: a.relatedTitle }))
          : n.createElement(
              'div',
              { style: t },
              n.createElement(m, { emojis: a.content, itemSize: l, onEmojiClick: r, ItemComponent: d })
            )
      })
    },
    38297: (e, t, o) => {
      ...
      function h(e) {
              ...
              (function (e, t) {
                ...
                return (
                  e.forEach(({ title: e, emojis: n }) => {
                    ...
                    let i = []
                    for (const a of n)
                      i.length < t ? i.push(a) : (o.push({ type: 'emojiRow', relatedTitle: e, content: i }), (i = [a]))
                    i.length &&
                      o.push({
                        type: 'emojiRow',
                        relatedTitle: e,
        ...
        const [k, S] = (0, n.useState)((null === (t = x[0]) || void 0 === t ? void 0 : t.relatedTitle) || ''),
          F = (0, n.useCallback)((e) => {
            w.current || S(e)
          }, [])
        return n.createElement(
          ...
          n.createElement(r.GroupTabs, {
            ...
            onTabClick: function (e) {
              ...
              L(
                (function (e) {
                  return x.findIndex(({ relatedTitle: t, type: o }) => 'title' === o && t === e)
                })(e)
              )
            },
          }),
        ...
        function L(e) {
          var t
          c.CheckMobile.iOS() && C.current && (C.current.style.overflow = 'hidden'),
            (w.current = !0),
            null === (t = f.current) || void 0 === t || t.scrollToItem(e, 'start'),
            requestAnimationFrame(() => {
              var t
              null === (t = f.current) || void 0 === t || t.scrollToItem(e, 'start'),
                c.CheckMobile.iOS() && C.current && (C.current.style.overflow = 'auto'),
                (w.current = !1)
            })
        }
      }
    ...
    26601: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        r = o(11123)
      const s = n.memo((e) => {
        const { emojis: t, itemSize: o, onEmojiClick: i, ItemComponent: s, className: c } = e
        return n.createElement(
          'div',
    ...
    85034: (e, t, o) => {
      ...
      var n = o(50959),
        ...
        l = o(17373)
      function r(e) {
        const { tab: t, isActive: o, onTabClick: i, children: r, className: s } = e
        return n.createElement(
          'div',
          {
      ...
      function c(e) {
        ...
        return n.createElement(
          ...
          o.map(({ title: e, content: o }) =>
            n.createElement(r, { key: e, tab: e, className: c, isActive: t === e, onTabClick: i }, o)
          )
        )
      }
    },
    ...
    83682: (e, t, o) => {
      ...
      const u = 34
      function d(e) {
        const { className: t, emoji: o, size: i = u, onClick: l, ItemComponent: r = s } = e
        return n.createElement(
          'div',
          {
    ...
    70412: (e, t, o) => {
      'use strict'
      o.d(t, { hoverMouseEventFilter: () => a, useAccurateHover: () => l, useHover: () => i })
      var n = o(50959)
      function i() {
      ...
      function d(e) {
        ...
        return n.createElement(
          G,
          {
            ...
            'aria-selected': d,
            'aria-checked': h,
            className: i(m, z.item, C && z.withIcon, { [z.isActive]: w, [z.isDisabled]: T || x, [z.hovered]: E }),
            title: v,
            href: k,
            target: L,
            rel: A,
            ...
            onClick: function (t) {
              const { dontClosePopup: o, onClick: n, onClickArg: i, trackEventObject: r } = e
              if (T) return
          ...
          (void 0 !== b || f) &&
            n.createElement('span', { className: z.shortcut }, (Z = b) && Z.split('+').join(' + ')),
          void 0 !== y &&
            n.createElement(
              'span',
              { onClick: D ? u : void 0, className: i(z.toolbox, { [z.showOnHover]: S, [z.showOnFocus]: F }) },
              y
            )
        )
        var Z
        ...
        return (
          ...
          (0, n.useLayoutEffect)(() => {
            if (l.CheckMobile.iOS())
              return (
                null !== r.current && (0, i.disableBodyScroll)(r.current, { allowTouchMove: s(r) }),
                () => {
    ...
    54079: (e, t, o) => {
      ...
      const d = (0, n.forwardRef)(function (e, t) {
        const { onKeyDown: o, orientation: d, ...m } = e,
          v = r.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': d } : {},
          ...
          n.createElement('div', {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              const i = () => {
                  ...
                  ;(0, s.becomeSecondaryElement)(o[n]), (0, s.becomeMainElement)(o[e]), o[e].focus()
                },
                a = () => {
                  const e = (n + o.length + 1) % o.length
                  ;(0, s.becomeSecondaryElement)(o[n]), (0, s.becomeMainElement)(o[e]), o[e].focus()
    ...
    14186: (e, t, o) => {
      ...
      class A extends n.PureComponent {
        ...
        render() {
          const {
            ...
            { heightContent: s, heightWrap: c, isVisibleBotButton: u, isVisibleTopButton: d } = this.state
          return n.createElement(S.Measure, { onResize: this._handleResizeWrap }, (h) =>
            n.createElement(
              'div',
              ...
              n.createElement(
                ...
                n.createElement(S.Measure, { onResize: this._handleResizeContent }, (t) =>
                  n.createElement('div', { className: F.content, ref: t }, e)
                )
              ),
              o && n.createElement('div', { className: r()(F.fadeTop, { [F.isVisible]: d && s > c }) }),
              o && n.createElement('div', { className: r()(F.fadeBot, { [F.isVisible]: u && s > c }) }),
              i &&
                n.createElement(
                  'div',
                  { className: r()(F.scrollTop, { [F.isVisible]: d && s > c }), onClick: this._handleScrollTop },
                  n.createElement(
                    'div',
              ...
              i &&
                n.createElement(
                  'div',
                  { className: r()(F.scrollBot, { [F.isVisible]: u && s > c }), onClick: this._handleScrollBot },
                  n.createElement(
                    'div',
                    { className: F.iconWrap },
                    n.createElement(x.Icon, { icon: L, className: F.icon })
      ...
      function z(e) {
        const { id: t, action: o, isActive: i, isHidden: a, isTransparent: l, toolName: r } = e
      ...
      const oe = [
        ...
        ne = ['0xF153', '0xF154', '0xF155', '0xF156', '0xF157', '0xF158', '0xF159', '0xF195', '0xF15A'],
        ie = [
          '0xF060',
          '0xF061',
          '0xF062',
      ...
      const ue = [
        ...
        he = [
          ...
          { title: j.Stickers, content: n.createElement(K, { text: C.t(null, void 0, o(84121)) }) },
          { title: j.Icons, content: n.createElement(K, { text: C.t(null, void 0, o(92464)) }) },
        ]
      var me = o(3343),
        ve = o(20520),
        pe = o(27317),
      ...
      const we = o(22878),
        Te = (0, n.forwardRef)((e, t) => {
          const {
            ...
            E = (0, fe.mergeThemes)(pe.DEFAULT_MENU_THEME, { menuBox: b.menuBox }),
          ...
          return (
            ...
            n.createElement(
              ...
              {
                ...T,
                className: l(b.dropdown, { [b.isGrayed]: m, [b.isActive]: h, [b.isOpened]: k }),
                onClick: m ? v : void 0,
                onKeyDown: function (e) {
                  var t
                  if (e.defaultPrevented || !(e.target instanceof Node) || !N.PLATFORM_ACCESSIBILITY_ENABLED) return
                  const o = (0, me.hashFromEvent)(e)
                  if (e.currentTarget.contains(e.target) || 27 !== o) return
                  e.preventDefault(),
                    V(!1),
                    F && (null === (t = null == j ? void 0 : j.current) || void 0 === t || t.focus())
                },
                ref: A,
              },
              n.createElement(
                ...
                n.createElement(
                  'div',
                  {
                    ...
                    className: l(
                      b.buttonWrap,
                      { 'apply-common-tooltip common-tooltip-vertical': Boolean(r || c) },
                ...
                !m &&
                  ...
                  n.createElement(
                    _,
                    {
                      ...
                      onKeyDown: function (e) {
                        if (e.defaultPrevented || !(e.target instanceof Node) || !N.PLATFORM_ACCESSIBILITY_ENABLED)
                          return
                      ...
                      type: N.PLATFORM_ACCESSIBILITY_ENABLED ? 'button' : void 0,
                      'data-role': N.PLATFORM_ACCESSIBILITY_ENABLED ? void 0 : 'menu-handle',
                      ref: j,
                      tabIndex: P,
                      'aria-pressed': N.PLATFORM_ACCESSIBILITY_ENABLED ? h : void 0,
                      'aria-label': N.PLATFORM_ACCESSIBILITY_ENABLED ? u : void 0,
                      'data-tooltip': u,
                    },
                    n.createElement(x.Icon, { className: b.arrowIcon, icon: Ce })
                  )
              ),
              !m &&
                (g
                  ? k && n.createElement(be.Drawer, { className: b.drawer, onClose: O, position: 'Bottom' }, d)
                  : n.createElement(
                      ve.PopupMenu,
                      {
                        theme: E,
                        ...
                        tabIndex: N.PLATFORM_ACCESSIBILITY_ENABLED ? -1 : void 0,
                      },
                      d
                    ))
            )
          ...
          function U() {
            if (s.mobiletouch && !p) !z.current && f && f()
              ...
              if (D.current) return clearTimeout(D.current), (D.current = 0), void V(!0)
          ...
          function G() {
            clearTimeout(z.current), (z.current = 0), clearTimeout(D.current), (D.current = 0)
          }
          function Z(e) {
          ...
          function K() {
            z.current &&
              ...
              (z.current = 0),
              k ? V(!1) : p || k || s.mobiletouch || (!h && !w) ? !D.current && f && f() : V(!0))
          }
        })
      var Ee = o(38297),
        xe = o(85034),
      ...
      function Ae(e) {
        ...
        return n.createElement(n.Suspense, { fallback: null != t ? t : null }, n.createElement(ye, { ...o }))
      }
      const ye = n.lazy(async () => {
        ...
        return {
          default: (t) => {
            ...
            return n.createElement(x.Icon, { icon: a, className: Le.iconContainer })
          },
        }
      })
      var Me = o(20274)
      var Ie = o(173)
      const Ne = new Se('RECENT_EMOJIS_CHANGED', 'linetoolemoji.recents', Ie.removeUnavailableEmoji, 'emojiTool'),
        Be = [
          'elon',
          'doge',
          'dislike',
      ...
      const We = [
          ...
          { title: 'TradingView', emojis: Be, content: n.createElement(G.IconItem, { icon: ze }) },
        ],
        je = new Se(
      ...
      const Ge = {
        [j.Icons]: {
          ...
          ItemComponent: function (e) {
            const { emoji: t, className: o } = e
            return n.createElement('div', { className: r()(Me.item, o) }, n.createElement(Ae, { charCode: Number(t) }))
          },
          icons: ue,
          onEmojiSelect: (e) => {
        ...
        [j.Stickers]: {
          ...
          RowComponent: function (e) {
            return n.createElement(He.EmojisRow, { ...e, className: Ue.stickerRow })
          },
          icons: We,
          onEmojiSelect: (e) => {
      ...
      var Ze = o(12451)
      function Ke(e) {
        const { isSmallTablet: t, maxHeight: o, activeTab: i, setActiveTab: a } = e,
          r = Ge[i],
          { service: s, ItemComponent: c, RowComponent: u, onEmojiSelect: d, getEmojiSize: h } = r,
          m = h && h(t),
      ...
      var qe = o(10888),
        Ye = o(37531)
      const $e = { icon: C.t(null, void 0, o(26579)), dropdownTooltip: C.t(null, void 0, o(92464)) },
        Qe = (0, fe.mergeThemes)(we, { menuBox: Ye.menuBox, drawer: Ye.drawer }),
      ...
      function et(e) {
        ...
        return n.createElement(
          Te,
          {
            ...
            onClickWhenGrayed: () =>
              (0, h.emit)('onGrayedObjectClicked', { type: 'drawing', name: b.lineToolsInfo[s].localizedName }),
      ...
      class it extends n.PureComponent {
        ...
        render() {
          return this.state.isVisible
            ? n.createElement(z, { action: this._handleClick, isTransparent: !0, toolName: 'zoom-out' })
      ...
      class ut extends n.PureComponent {
        ...
        render() {
          const { favoriting: e, grayedTools: t, lineTools: o, dropdownTooltip: i, isSmallTablet: a } = this.props,
            ...
            n.createElement(
              ...
              o.map((o, i) => {
                ...
                return n.createElement(rt.PopupMenuItem, {
                  ...
                  shortcut: !a && o.hotkeyHash ? (0, w.humanReadableHash)(o.hotkeyHash) : void 0,
                  icon: u.icon,
                  isActive: s && l === i,
                  appearAsDisabled: h,
      ...
      class gt extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleRemoveDrawings = () => {
              bt('remove drawing'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllDrawingTools()
            }),
            (this._handleRemoveStudies = () => {
              bt('remove indicator'), this.props.chartWidgetCollection.activeChartWidget.value().removeAllStudies()
            }),
            ...
            (this._getActualState = () => {
              ...
              const e = this._activeChartWidget.model().dataSources(),
                ...
                o = e.filter(vt.isStudy).filter((e) => e.removeByRemoveAllStudies())
        ...
        render() {
          const e = this.props.isSmallTablet ? mt : void 0,
            ...
            a = C.t(null, { plural: '{amount} drawings', count: t, replace: { amount: t.toString() } }, o(93030)),
            l = C.t(null, { plural: '{amount} indicators', count: i, replace: { amount: i.toString() } }, o(80437)),
            r = C.t(null, { replace: { drawings: a } }, o(30513)),
            s = C.t(null, { replace: { indicators: l } }, o(55084)),
            c = C.t(null, { replace: { drawings: a, indicators: l } }, o(10049))
          return n.createElement(
            Te,
            {
      ...
      const xt = {
        ...
        all: { active: J.drawingToolsIcons.hideAllDrawingsActive, inactive: J.drawingToolsIcons.hideAllDrawings },
      }
      function _t(e) {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            Array.from((0, Ct.getHideOptions)()).map(([e, o]) =>
              n.createElement(Et, { key: e, hideMode: e, option: o, isSmallTablet: t, onClick: m })
            )
          )
        )
        function m(e, t) {
          kt((0, a.ensureDefined)((0, Ct.getHideOptions)().get(e)).trackLabel, t)
        }
      }
      function kt(e, t) {
      ...
      class yt extends n.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = (0, a.ensureNotNull)((0, Ft.getFavoriteDrawingToolbarPromise)()))
          e.then((t) => {
            this._promise === e &&
              ((this._instance = t),
      ...
      function zt(e) {
        const { isSmallTablet: t } = e,
          o = (0, Mt.useWatchedValueReadonly)({ watchedValue: (0, Nt.magnetEnabled)() }),
          i = (0, Mt.useWatchedValueReadonly)({ watchedValue: (0, Nt.magnetMode)() })
        return n.createElement(
          'div',
          ...
          n.createElement(
            ...
            Object.values(Dt).map(({ id: e, name: l, localizedName: r, icon: s }) =>
              n.createElement(rt.PopupMenuItem, {
                key: e,
        ...
        function a(e) {
          void 0 !== e &&
            ((0, dt.trackEvent)('GUI', 'Magnet mode', e === It.MagnetMode.WeakMagnet ? 'Weak' : 'Strong'),
      ...
      const Jt = (0, fe.mergeThemes)(Ut, Kt),
        qt = { hide: C.t(null, void 0, o(96411)), show: C.t(null, void 0, o(63354)) }
      class Yt extends n.PureComponent {
        constructor() {
          super(...arguments),
            (this._toggleVisibility = () => {
              E.isDrawingToolbarVisible.setValue(!E.isDrawingToolbarVisible.value())
            })
        }
        render() {
          ...
          return n.createElement(
            'div',
            {
              className: l(Jt.toggleButton, 'apply-common-tooltip common-tooltip-vertical', !e && Jt.collapsed),
              onClick: this._toggleVisibility,
              title: e ? qt.hide : qt.show,
              'data-name': t,
              'data-value': e ? 'visible' : 'collapsed',
            },
            n.createElement(Zt, { direction: e ? 'left' : 'right', theme: e ? void 0 : Jt })
          )
        }
      }
      var $t = o(37558),
      ...
      class co extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._handleObjectsTreeClick = () => {
              this._activeChartWidget().showObjectsTreeDialog(), uo('object tree')
            }),
            (this._handleMouseOver = (e) => {
              ;(0, Wt.hoverMouseEventFilter)(e) && this.setState({ isHovered: !0 })
            }),
            (this._handleMouseOut = (e) => {
              ;(0, Wt.hoverMouseEventFilter)(e) && this.setState({ isHovered: !1 })
            }),
            ...
            (this._filteredLineTools = T.map((e) => ({
              id: e.id,
              title: e.title,
              items: e.items.filter((e) => this._toolsFilter.isToolEnabled(b.lineToolsInfo[e.name].localizedName)),
              trackLabel: e.trackLabel,
            })).filter((e) => 0 !== e.items.length)),
            this._filteredLineTools.forEach((e) =>
              e.items.forEach((e) => {
                this._grayedTools[e.name] = this._toolsFilter.isToolGrayed(b.lineToolsInfo[e.name].localizedName)
              })
            ),
            (this.state = {
              isHovered: !1,
        ...
        render() {
          ...
          let c
          c = n.createElement(Yt, { toolbarVisible: a, 'data-name': 'toolbar-drawing-toggle-button' })
          const h = () => !!this._features.tools && !(!u.enabled('show_object_tree') || (io && !no))
          return n.createElement(
            to.RegistryProvider,
            ...
            n.createElement(
              ...
              n.createElement(
                $t.DrawerManager,
                null,
                n.createElement(Xt.MatchMedia, { rule: Qt.DialogBreakpoints.TabletSmall }, (e) =>
                  n.createElement(
                    Ot.Toolbar,
                    {
                      id: 'drawing-toolbar',
                      ...
                      n.createElement(
                        ...
                        !o &&
                          n.createElement(
                            ...
                            this._features.tools && n.createElement(_t, { isSmallTablet: e }),
                            !1
                          ),
                        !o &&
                          this._features.tools &&
                        ...
                        n.createElement('div', { className: oo.fill, style: r }),
                        !o &&
                          (this._features.tools || !1) &&
                          n.createElement(
                            'div',
                            { className: l(oo.group, oo.lastGroup), style: r },
                            !1,
                            this._features.tools &&
                              this._features.favoriting &&
                              n.createElement(yt, { id: Rt.FavoriteDrawings }),
                            h() &&
                              n.createElement(z, {
                                id: Rt.ObjectTree,
        ...
        _negotiateResizer() {
          ...
          this.props.resizerBridge.negotiateWidth(this.state.isVisible ? Pt.TOOLBAR_WIDTH_EXPANDED : e)
        }
        _handleGlobalClose() {
          lo.fire()
        }
      ...
      class ho {
        constructor(e, t) {
          ;(this._component = null),
            ...
            (this._container = e),
            i.render(n.createElement(co, { ...t, ref: this._handleRef }), this._container)
        }
        destroy() {
    ...
    5962: (e, t, o) => {
      'use strict'
      o.d(t, { RegistryProvider: () => s, registryContextType: () => c, validateRegistry: () => r })
      var n = o(50959),
        i = o(19036),
        a = o.n(i)
