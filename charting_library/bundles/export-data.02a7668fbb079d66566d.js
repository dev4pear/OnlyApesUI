    ...
    50210: (e, t, i) => {
      ...
      function f(e, t = {}) {
        const i = Object.assign({}, d, t),
          ...
          f = e.mainSeries(),
          p = (0, c.getChartWidgetApiTimeConverter)(f.interval(), (0, l.ensureNotNull)(f.symbolInfo()), e),
          v = (function (e, t) {
        ...
        const x = (function (e, t, i, s, r) {
          const a = (0, l.ensureNotNull)(e.range().value(), 'time scale points range'),
            c = (function (e, t, i, s) {
              var r, a
              const c = s.from,
                d = s.to,
                f = e.range().value(),
                h = (0, l.ensureNotNull)(void 0 !== c ? e.indexOf(c, !0) : (0, l.ensureNotNull)(f).firstIndex),
              ...
              for (let e = 0; e < t.length; e++) {
                const l = t[e],
                  n = s.includeOffsetStudyValues
                    ? (0, u.max)(
                        null !== (a = null === (r = i[e]) || void 0 === r ? void 0 : r.fieldPlotOffsets) && void 0 !== a
                          ? a
                          : [0]
                      )
                    : 0,
              ...
              return (0, l.assert)(p <= T, 'Range must contain at least 1 time point'), new n.BarsRange(p, T)
            })(e, t, i, r),
            d = c.firstBar(),
            f = c.lastBar(),
            m = []
        ...
        if (i.includeSeries) {
          ...
          e.each((e, l) => {
            const n = s.data[e - P],
              ...
              a = g(l[3]),
              u = g(l[4])
            if (((n[b] = o), (n[b + 1] = r), (n[b + 2] = a), (n[b + 3] = u), i.includeDisplayedValues)) {
              const i = s.displayedData[e - P]
              ;(i[b] = t(o)), (i[b + 1] = t(r)), (i[b + 2] = t(a)), (i[b + 3] = t(u))
            }
            return !1
          })
        }
          ...
          for (let e = 0; e < l.fields.length; ++e) {
            ...
            t.data()
              ...
              .each((e, t) => {
                const l = s.data[e - a],
                  o = g(t[r])
                return (l[c] = o), i.includeDisplayedValues && (s.displayedData[e - a][c] = n(o)), !1
              })
          }
          w += l.fields.length
        }
      ...
      function m(e) {
        ...
        for (let u = 0; u < t.plots.length; ++u) {
          ...
          const h = `${d.title}${f}`
          n.fields.push(p(o, a, h)), n.fieldToPlotIndex.push(u + 1), n.fieldPlotOffsets.push(e.offset(c.id))
        }
        return n
      }
      function p(e, t, i) {
