  ...
  [5518],
  {
    ...
    28985: (e, t, r) => {
      ...
      const m = [
        ...
        g = [
          { id: 'horizontal', value: 'horizontal', title: D.t(null, void 0, r(77405)) },
          { id: 'vertical', value: 'vertical', title: D.t(null, void 0, r(44085)) },
        ],
      ...
      var H = r(58275),
        _ = r.n(H)
      function W(e, t, r, i) {
        return { id: t, title: r, visible: i, groupType: 'general', definitions: new (_())(e) }
      }
      function Y(e, t, r) {
        return { id: t, title: r, groupType: 'leveledLines', definitions: new (_())(e) }
      }
      var R = r(3347)
      function G(e, t) {
        const r = new Map(),
      ...
      function Z(e, t, r, i, o) {
        ...
        } else n = (0, R.makeProxyDefinitionProperty)(t, [() => X(t.value(), 0), (e) => e])
        return (
          (n.setValue = (r) => {
