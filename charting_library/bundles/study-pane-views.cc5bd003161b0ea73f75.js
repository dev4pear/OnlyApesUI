        ...
        hitTest(t, e) {
          ...
          for (const s of i.histograms) {
            ...
            for (const l of s.bars) {
              ...
              if (d.location === a.HHistLocation.Absolute && (s.xRange.min >= t.x || t.x >= s.xRange.max)) continue
              null === r &&
                ((r = 0),
                s.bars.forEach((t) => {
              ...
              for (let e = 0; e < l.subBarValues.length; e++) {
                ...
                if (((_ = o), ((t.x >= a && t.x <= o) || (t.x >= o && t.x <= a)) && t.y >= i && t.y <= s))
