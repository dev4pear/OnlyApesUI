  ...
  [6456],
  {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement('div', { className: a()(n ? _.textWrap : _.ellipsis) }, t),
              i && r.createElement('div', { className: a()(_.ellipsis, _.subtitle) }, i)
            ),
            u,
            o &&
              !b &&
              r.createElement(
                ...
                r.createElement(v.Icon, { className: _.icon, icon: y, 'data-name': 'close', 'data-role': 'button' })
              )
          )
        )
      }
      ...
      class x extends r.PureComponent {
        ...
        render() {
          const {
            ...
            q = 'after' !== m ? v : void 0,
            Z = 'after' === m ? v : void 0,
            U = 'string' == typeof o ? o : M || '',
            K = (0, C.mergeRefs)([this._handleReference, O])
          return r.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.SmallHeight }, (m) =>
            r.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, (d) =>
              r.createElement(
                ...
                r.createElement(
                  'div',
                  { className: a()(E.wrapper, t), 'data-name': l, 'data-dialog-name': U },
                  void 0 !== o &&
                    r.createElement(b, {
                      draggable: N && !(d || P),
                  ...
                  x && r.createElement(u.Separator, { className: E.separator }),
                  r.createElement(p.PopupContext.Consumer, null, (e) => this._renderChildren(e, d || P))
                )
              )
            )
          )
    ...
    50366: (e, t, n) => {
      ...
      function h(e) {
        ...
        return r.createElement(
          'div',
          { ...h, className: o()(c.tab, f && c.isTablet, p && c.isMobile, u && c.active), onClick: d },
          r.createElement(a.Icon, { className: c.icon, icon: m }),
          !f &&
            r.createElement(
              'span',
              { className: c.title },
    ...
    57979: (e, t, n) => {
        ...
        const i = (0, r.useContext)(S),
          ...
          F =
            null !== (t = e.favoriteClickHandler) && void 0 !== t
              ...
              ? L(i.toggleFavorite, l)
              : void 0,
          O = (0, P.useWatchedValueReadonly)({ watchedValue: I.watchedTheme }) === D.StdTheme.Dark ? T.dark : T.light,
          j = v()(T.container, l.isGrayed && T.disabled, f && T.selected, m && T.highlighted, m && O)
        return r.createElement(
          'div',
          {
            ref: g,
          ...
          r.createElement(
            'div',
            { className: v()(T.main, !A && T.paddingLeft) },
            A &&
      ...
      function O(e) {
        ...
        return r.createElement('div', { style: t, className: F.container }, n)
      }
      var j = n(9745),
        W = n(94720),
        H = n(70722)
      ...
      function ee(e) {
        return -1 === ne(e)
          ? ((function (e) {
              !te(e) && (X.push(e), ie(), Y.fire(e))
            })(e),
            !0)
          : ((function (e) {
              const t = ne(e)
              ;-1 !== t && (X.splice(t, 1), ie(), J.fire(e))
            })(e),
            !1)
      }
      function te(e) {
                  ...
                  r.createElement(
                    ...
                    I
                      ...
                      ? r.createElement(
                          r.Fragment,
                          null,
                          r.createElement(O, null, r.createElement(z, { title: o.t(null, void 0, n(15491)) })),
                          f
                            .slice()
                            .sort(ae)
                            .map((e) => {
      ...
      class de extends class {
        ...
        _applyStudy(e, t) {
          var n
          e.isGrayed
            ? se.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
        ...
        async _init() {
          ...
          ;(this._indicatorData = await (async function (e, t) {
            let n = { ...t }
            return [...ue(n, 'tv-basicstudies'), ...ue(n, 'Script$STD'), ...ue(n, 'tv-volumebyprice')]
        ...
        _render() {
          ...
          i.render(r.createElement(oe, { ...e }), t)
        }
      }
    },
    36189: (e, t, n) => {
    ...
    95257: (e, t) => {
      ...
      var B = { current: null },
        T = { transition: null },
        A = { ReactCurrentDispatcher: B, ReactCurrentBatchConfig: T, ReactCurrentOwner: w }
      ;(t.Children = {
        map: D,
    ...
    44463: (e) => {
      e.exports = {
        ...
        pl: 'Available for Pro accounts',
        pt: ['Disponível para contas Pro'],
        ro: 'Available for Pro accounts',
        ru: ['Доступно для подписок Pro'],
        sv: 'Available for Pro accounts',
        th: ['มีให้สำหรับบัญชี Pro'],
        tr: 'Available for Pro accounts',
        vi: ['Dành cho các tài khoản Pro'],
        zh: 'Available for Pro accounts',
        zh_TW: 'Available for Pro accounts',
      }
    },
    92490: (e) => {
      e.exports = {
