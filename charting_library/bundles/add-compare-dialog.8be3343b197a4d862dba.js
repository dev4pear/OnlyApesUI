    ...
    89035: (e, t, o) => {
      ...
      function T(e) {
        const { fullSymbolName: t, isSelected: n, className: s, isYield: l } = e,
          { isMobile: d, searchRef: u, setMode: m } = (0, k.useEnsuredContext)(y.SymbolSearchItemsDialogContext),
          {
            compareModel: h,
          ...
          { callback: g } = (0, k.useEnsuredContext)(x),
          _ = h.comparableOnSameScale({ isYield: l }),
          E = _ ? z.CompareOption.SameScale : z.CompareOption.SamePctScale,
        ...
        return d
          ...
          : r.createElement(
              ...
              r.createElement(M, { onClick: A, value: E, isItemSelected: Boolean(n), isSelected: n && p === E }, N),
              r.createElement(
                M,
                {
                  onClick: A,
      ...
      var B = o(15550),
        ...
        H = o(78724)
      function O(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)((0, r.useContext)(y.SymbolSearchItemsDialogContext)),
      ...
      function K(e) {
        const {
          ...
          z = (0, h.useWatchedValueReadonly)({ watchedValue: b.studies() }),
          D = a[n],
          L = 'compare' === c,
          T = 'exchange' === c
        return (
                ...
                case 13: {
                  if (L)
                    return void (function () {
                      if (-1 === I) return
                      const e = z[I]
                      e.checked ? b.removeStudy(e) : b.applyStudy(e.symbol, x, M)
                      C(-1)
                    })()
                  const t = j()
                  ...
                  a &&
                    N &&
                    (i([{ symbol: f ? a.toUpperCase() : a, resolved: !1, compareOption: x, allowExtendTimeScale: M }]),
                    N(o, d))
                  break
                }
                case 27:
      ...
      var X = o(81319),
        ...
        $ = o(70613)
      function ee(e) {
        const { searchRef: t, setMode: o } = (0, k.useEnsuredContext)(y.SymbolSearchItemsDialogContext),
      ...
      function u(e) {
        ...
        return r.createElement(
          q,
          {
            ...
            'aria-selected': u,
            'aria-checked': m,
            className: a(h, j.item, g && j.withIcon, { [j.isActive]: S, [j.isDisabled]: _ || x, [j.hovered]: k }),
            title: p,
            href: I,
            target: N,
            rel: M,
            reference: function (e) {
              ;(U.current = e), 'function' == typeof D && D(e)
          ...
          void 0 !== g &&
            r.createElement('span', {
              ...
              className: a(j.icon, R && l['round-icon']),
              dangerouslySetInnerHTML: { __html: g },
            }),
          r.createElement(
            'span',
            { className: a(j.labelRow, v) },
            r.createElement('span', { className: a(j.label, f) }, w)
          ),
          (void 0 !== b || y) &&
            r.createElement('span', { className: j.shortcut }, (K = b) && K.split('+').join(' + ')),
          void 0 !== z &&
            r.createElement(
              'span',
              { onClick: B ? d : void 0, className: a(j.toolbox, { [j.showOnHover]: C, [j.showOnFocus]: E }) },
              z
            )
        )
        var K
