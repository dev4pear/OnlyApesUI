  ...
  [9374],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (r) {
              ...
              if ('string' === i || 'number' === i) e.push(r)
                ...
                a && e.push(a)
              } else if ('object' === i) for (var s in r) o.call(r, s) && r[s] && e.push(s)
            }
          }
          return e.join(' ')
        }
        ...
        return (
          (0, o.useLayoutEffect)(() => {
            const e = { click: t, mouseDown: r, touchEnd: i, touchStart: a },
              o = u ? u.current : c.current
            return (0, n.addOutsideEventListener)(d.current, o, s, l, e)
          }, [t, r, i, a, s]),
          u || c
        )
      }
      ...
      function l(e) {
        ...
        if (e && 1 == ++s) {
          ...
          'hidden' !== e.toLowerCase() &&
            ...
            (n(r, 'right', `${o()}px`), (t.style.paddingRight = `${s + o()}px`), (u = !0)),
            t.classList.add('i-no-scroll')
        } else if (!e && s > 0 && 0 == --s && (t.classList.remove('i-no-scroll'), u)) {
          n(r, 'right', '0px')
          let e = 0
          0, t.scrollHeight <= t.clientHeight && (e -= o()), (t.style.paddingRight = (e < 0 ? 0 : e) + 'px'), (u = !1)
        }
      }
    },
    9481: (e, t, r) => {
      ...
      class u extends o.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            n.createPortal(o.createElement(l.Provider, { value: this }, this.props.children), e)
          )
        }
        moveToTop() {
    ...
    95257: (e, t) => {
      ...
      function M(e, t, o) {
        ...
        if (e && e.defaultProps) for (n in (u = e.defaultProps)) void 0 === i[n] && (i[n] = u[n])
      ...
      function L(e, t, n, i, a) {
        ...
        if (((u = 0), (i = '' === i ? '.' : i + ':'), k(e)))
          ...
          for (e = c.call(e), l = 0; !(s = e.next()).done; ) u += L((s = s.value), t, n, (c = i + I(s, l++)), a)
        else if ('object' === s)
          throw (
            ((t = String(e)),
            Error(
      ...
      ;(t.Children = {
        ...
        (t.cloneElement = function (e, t, o) {
          ...
          if (null != t) {
            ...
            for (l in t) D.call(t, l) && !T.hasOwnProperty(l) && (n[l] = void 0 === t[l] && void 0 !== u ? u[l] : t[l])
          }
    ...
    18510: (e, t, r) => {
      'use strict'
      r.r(t), r.d(t, { showSymbolInfoDialog: () => G })
      var o = r(962),
        n = r(50959),
        i = r(50151),
        a = r(967),
      ...
      class N extends n.PureComponent {
        ...
        render() {
          return n.createElement(
            ...
            n.createElement(T, { onClose: this.props.onClose }, u.t(null, void 0, r(12014))),
            n.createElement(
              z,
              null,
      ...
      function F(e) {
        if (void 0 === e.minmov || void 0 === e.pricescale) return null
        const { variable_tick_size: t, ...r } = e
        return (0, f.createSeriesFormatter)(r, 'default').format(e.minmov / e.pricescale)
      }
      function B(e) {
        var t
      ...
      function G(e, t) {
        ...
        const n = t && t.symbolInfo,
          a = [
            ...
            { title: u.t(null, void 0, r(90656)), propName: 'type', getter: B },
            {
            ...
            { title: u.t(null, void 0, r(22992)), propName: 'front_contract', visibility: J },
            { title: u.t(null, void 0, r(64659)), propName: 'pointvalue' },
            { title: u.t(null, void 0, r(77295)), propName: 'exchange', visibility: V },
            { title: u.t(null, void 0, r(91617)), propName: 'listed_exchange', visibility: V },
            { title: u.t(null, void 0, r(46147)), propName: 'source', getter: K, visibility: Z },
            {
            ...
            { title: u.t(null, void 0, r(45221)), propName: 'pip_size', getter: R, visibility: O },
            { title: u.t(null, void 0, r(55209)), propName: 'tick_size', getter: F },
            { title: u.t(null, void 0, r(31672)), propName: 'sector' },
            { title: u.t(null, void 0, r(91746)), propName: 'industry' },
            { title: u.t(null, void 0, r(87492)), propName: 'timezone', formatter: W.timezoneTitle, visibility: H },
            {
      ...
      function X(e) {
        const t = new U.SessionSpec('Etc/UTC', e),
          o = { weekDays: P, closed: u.t(null, void 0, r(25219)) }
