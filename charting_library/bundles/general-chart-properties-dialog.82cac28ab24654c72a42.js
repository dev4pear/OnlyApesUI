;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7078],
  {
    ...
    50366: (e, t, a) => {
      ...
      function h(e) {
        const { mode: t, title: a, icon: n, isActive: m, onClick: d, ...h } = e,
          { isMobile: p, isTablet: u } = r(t),
          g = m ? (null == n ? void 0 : n.active) : null == n ? void 0 : n.default
        return i.createElement(
          'div',
          { ...h, className: l()(c.tab, u && c.isTablet, p && c.isMobile, m && c.active), onClick: d },
          i.createElement(s.Icon, { className: c.icon, icon: g }),
          !u &&
            i.createElement(
              'span',
              { className: c.title },
              i.createElement('span', { className: c.titleText }, a),
              p && i.createElement(s.Icon, { className: c.nested, icon: o })
            )
        )
      }
    },
    72811: (e, t, a) => {
      'use strict'
      a.r(t), a.d(t, { GeneralChartPropertiesDialogRenderer: () => $ })
      var i = a(44352),
        n = a(50959),
        l = a(962),
        s = a(94720),
      ...
      function I(e) {
        ...
        return n.createElement(
          ...
          n.createElement(v.PopupMenuItem, {
            ...
            label: t,
            onClick: c,
            toolbox: n.createElement(z.RemoveButton, {
      ...
      var E = a(44996)
      const M = i.t(null, void 0, a(19611)),
        j = i.t(null, void 0, a(73169)),
        N = (0, C.appendEllipsis)(i.t(null, void 0, a(9908))),
        w = i.t(null, void 0, a(75819)),
        P = _.enabled('chart_template_storage')
      class B extends n.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              ;(0, y.loadTheme)(t, { themeName: a, standardTheme: !0, applyOverrides: !0, onlyActiveChart: !0 })
            }),
            (this._handleSaveAs = () => {
              if (P) {
                ...
                window.runOrSignIn(
                  () =>
                    (async function (e, t) {
                      const [i, n] = await Promise.all([a.e(7648).then(a.bind(a, 57351)), (0, y.getThemeNames)()])
        ...
        render() {
          return n.createElement(
            ...
            (e) => (
              (this._manager = e),
              n.createElement(u.MatchMedia, { rule: 'screen and (max-width: 768px)' }, (e) =>
                n.createElement(
                  b.ControlDisclosure,
                  {
                    id: 'series-theme-manager',
                    className: !e && D.themesButtonText,
                    hideArrowButton: e,
        ...
        _getPlaceHolderItem(e) {
          return e ? n.createElement(g.Icon, { className: D.themesButtonIcon, icon: E }) : M
        }
        _getThemeItems(e) {
          ...
          return n.createElement(
            ...
            e &&
              t &&
              n.createElement(v.PopupMenuItem, { className: D.defaultsButtonItem, isActive: !1, label: w, onClick: i }),
            n.createElement(v.PopupMenuItem, {
            ...
            l.length > 0 &&
              n.createElement(
                n.Fragment,
                null,
                n.createElement(k.PopupMenuSeparator, { key: 'separator' }),
                l.map((e) =>
                  n.createElement(I, {
                    key: e,
                    themeName: e,
      ...
      class X extends n.PureComponent {
        constructor(e) {
          ...
          super(e),
            (this._renderChildren = ({ requestResize: e, isSmallWidth: t }) => (
              ...
              n.createElement('div', { className: F.content }, this._renderTabs(t), this._renderTabContent(t))
            )),
            (this._renderApplyToAllButton = () =>
              n.createElement(u.MatchMedia, { rule: U.DialogBreakpoints.TabletNormal }, (e) =>
            ...
            (this._selectPage = (e, t) => {
              ...
              e !== a &&
                ...
                null !== e &&
                  (t || h().setValue(K, e.id), e.definitions.subscribe(this._onChangeActivePageDefinitions)),
            ...
            (this._syncApplyToAllVisibility = () => {
              ...
              this.setState({ isApplyToAllVisible: (0, p.isMultipleLayout)(e.layout.value()) })
            }),
          ...
          this.state = {
            activePage: s,
            visiblePages: l,
            isApplyToAllVisible: (0, p.isMultipleLayout)(e.chartWidgetCollection.layout.value()),
            tableKey: Date.now(),
          }
        }
        componentDidMount() {
        ...
        render() {
          ...
          return n.createElement(u.MatchMedia, { rule: U.DialogBreakpoints.TabletSmall }, (r) =>
            n.createElement(o.AdaptiveConfirmDialog, {
              ...
              additionalHeaderElement:
                null !== s && r ? n.createElement(q, { onClick: this._handleBackClick }) : void 0,
        ...
        _renderTabs(e) {
          ...
          return n.createElement(u.MatchMedia, { rule: U.DialogBreakpoints.TabletNormal }, (e) =>
            n.createElement(u.MatchMedia, { rule: U.DialogBreakpoints.TabletSmall }, (t) => {
      ...
      var Z = a(76422),
        Q = a(85067)
      const J = i.t(null, void 0, a(74207))
      class $ extends Q.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
