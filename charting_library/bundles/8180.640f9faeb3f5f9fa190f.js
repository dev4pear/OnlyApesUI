  ...
  [8180, 2215],
  {
        ...
        w = function (t, e) {
          var n,
            ...
            c =
              ...
              f(a, { x: r, y: o, width: i, height: u, top: o, right: r + i, bottom: u + o, left: r }),
              a)
    ...
    95257: (t, e) => {
      ...
      function R(t, e, r) {
        ...
        if (t && t.defaultProps) for (o in (a = t.defaultProps)) void 0 === i[o] && (i[o] = a[o])
            ...
            g(u)
              ...
              : null != u &&
                (k(u) &&
                  ...
                  })(u, o + (!u.key || (a && a.key === u.key) ? '' : ('' + u.key).replace(M, '$&/') + '/') + t)),
                e.push(u)),
            1
          )
        if (((a = 0), (i = '' === i ? '.' : i + ':'), g(t)))
          ...
          for (t = f.call(t), c = 0; !(s = t.next()).done; ) a += A((s = s.value), e, o, (f = i + x(s, c++)), u)
        else if ('object' === s)
          throw (
            ((e = String(t)),
            Error(
      ...
      ;(e.Children = {
        ...
        (e.cloneElement = function (t, e, r) {
          ...
          if (null != e) {
            ...
            for (c in e) E.call(e, c) && !S.hasOwnProperty(c) && (o[c] = void 0 === e[c] && void 0 !== a ? a[c] : e[c])
          }
        ...
        (e.isValidElement = k),
        (e.lazy = function (t) {
          return { $$typeof: h, _payload: { _status: -1, _result: t }, _init: C }
        }),
        (e.memo = function (t, e) {
