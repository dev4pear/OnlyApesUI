  ...
  [1583],
  {
    ...
    61144: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        c = i(53180),
        u = i(47043)
      const p = o.t(null, void 0, i(33241)),
        _ = o.t(null, void 0, i(16075))
      class g extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          0 !== n &&
            ...
            (u = !0)),
            0 !== r && (this._drawQuantity(t, d + n, c, u), this._drawQuantityText(t, d + n, c), (u = !0)),
    ...
    46258: (e, t, i) => {
      ...
      const { setLineStyle: c, drawLine: u, drawPoly: p } = i(68441),
        { LINESTYLE_SOLID: _ } = i(79849)
      class g extends h {
        constructor(e, t) {
        ...
        _drawImpl(e) {
          if (null !== this._data && this._data.points && !(this._data.points.length < 1)) {
            ...
            ;(this._cache.bodyRight = h + n),
              ...
              0 !== r &&
                (this._drawQuantity(t, this._cache.bodyRight, u), this._drawQuantityText(t, this._cache.bodyRight, u)),
              0 !== s && this._drawReverseButton(t, this._cache.quantityRight, u),
              0 !== this._closeButtonWidth() && this._drawCloseButton(t, this._cache.reverseButtonRight, u)
          }
        }
        hitTest(e) {
        ...
        _updateImpl(e, t) {
          ...
          if (h.showLabel && h.showLabel.value()) {
            ...
            this._customLabelRenderer.setData(v),
              ...
              'middle' === c &&
                (_.excludeBoundaries =
                  null !== (i = (0, a.getTextBoundaries)(this._customLabelRenderer, t, e)) && void 0 !== i ? i : void 0)
          }
      ...
      class A extends o.LineSourcePaneView {
        ...
        _creareMiddleLabel(e, t, i) {
          ...
          const R = _.qty.value() / _.lotSize.value(),
            y = 'futures' === i.type || (0, w.isCryptoSymbol)(i) ? Math.round(1e3 * R) / 1e3 : Math.floor(R)
    ...
    48063: (e, t, i) => {
      ...
      const L = 18,
        S = new (class {
          constructor(e, t) {
            ;(this._icons = new Map()), (this._onAllIconsLoaded = new (T())()), (this._pendingLoading = e.length)
            const i = () => {
      ...
      class M {
        ...
        draw(e, t) {
          ...
          if (this._rect) {
            if (
              ...
              let s = 0
              const o = Math.ceil((L - this._fontSize) / 2),
        ...
        _preRender() {
          ...
          const e = (function () {
              ...
              return (P = (0, R.getPrescaledContext2D)(e)), P
            })(),
      ...
      var D = I.fontSize,
        B = I.lineSpacing,
        z = I.paddingTopBottom
      const E = (0, N.getLogger)('Chart.LineToolTrendLine')
      function H(e, t) {
      ...
      class O {
        constructor(e) {
          ...
          const t = B,
            i = D + t
          ;(this._maxRowHeight = 3 * i - t + 2 * z + 2), this._recreateCanvas()
        }
        destroy() {
        ...
        _repaintSource(e, t, i) {
          ...
          ;(0, R.drawScaled)(this._ctx, s, s, () => {
            ...
            const r = new M(i, { widths: [] }).draw(this._ctx, this._params)
        ...
        _recreateCanvas() {
          ;(this._canvas = (0, n.ensureNotNull)(document.createElement('canvas'))),
            ...
            (this._ctx.font = `${D}px ${A.CHART_FONT_FAMILY}`),
            this._sourcesToRow.clear(),
            this._rowsToSources.clear()
        }
      }
      var V = i(9155)
      class W extends k.AlertableLineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._renderer = new l.CompositeRenderer()),
            ...
            (this._iconsReady = !1),
            S.onAllIconsReady().subscribe(this, () => {
              this._cache && (this._cache.destroy(), (this._cache = null)), (this._iconsReady = !0), t.lightUpdate()
            })
        }
        destroy() {
          this._cache && (this._cache.destroy(), (this._cache = null)), S.onAllIconsReady().unsubscribeAll(this)
        }
        iconsReady() {
        ...
        getCacheRects(e, t) {
          const i = this._createCacheIfRequired(e),
            ...
            h = a === V.StatsPosition.Auto ? V.StatsPosition.Center : a
          let c = l[h].x + 10,
            u = l[h].y
          const p =
          ...
          p ? (u -= 10 + d.height) : (u += 10),
            a !== V.StatsPosition.Auto ||
              (0, r.equalPoints)(l[V.StatsPosition.Left], l[V.StatsPosition.Right]) ||
              ...
              (0, s.intersectLineSegmentAndBox)(
                (0, r.lineSegment)(l[V.StatsPosition.Left], l[V.StatsPosition.Right]),
                (0, r.box)((0, r.point)(c, u), (0, r.point)(c + d.width, u + d.height))
              ) &&
                ((u = p ? l[h].y + 10 : l[h].y - 10 - d.height),
                (c = Math.min(l[V.StatsPosition.Center].x, e.cssWidth) - d.width)))
          return {
            cacheRect: d,
    ...
    28621: (e, t, i) => {
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawBackground(e, t, i) {
          ...
          let c = [new s.Point(0, 0), new s.Point(i.width, 0), new s.Point(i.width, i.height), new s.Point(0, i.height)]
          if (
            ((c = _(c, a, l, h)),
