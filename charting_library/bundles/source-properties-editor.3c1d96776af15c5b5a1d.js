      ...
      class E extends a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._lineToolsAffectChartInvalidation = new y.FeatureToggleWatchedValue(
            ...
            (this._getTranslatedStringForSource = (e) => new z.TranslatedString(e.name(), e.title())),
            (this._setTitle = (e) => {
              ...
              i.setProperty(t.properties().title, e, a, this._lineToolsAffectChartInvalidation.value())
            }),
            ...
            (this._renderFooterLeft = () => {
              ...
              return (0, g.isLineTool)(e)
                ...
                : a.createElement(
                    ...
                    (i) =>
                      (0, b.isStudy)(e) &&
                      a.createElement(f.StudyDefaultsManager, { model: t, source: e, mode: i ? 'compact' : 'normal' })
                  )
            }),
            (this._subscribe = (e) => {
        ...
        render() {
          ...
          const { onCancel: t, source: i } = this.props,
            ...
            r = (null === (e = i.properties().title) || void 0 === e ? void 0 : e.value()) || i.title(),
            o = a.createElement(D.Title, {
              isRenaming: n,
              onChangeMode: this._handleChangeMode,
              setTitle: this._setTitle,
              defaultTitle: r,
              canBeRenamed: (0, g.isLineTool)(i) && !x.enabled('widget'),
            })
          return a.createElement(u.AdaptiveConfirmDialog, {
            dataName: (0, b.isStudy)(i) ? 'indicator-properties-dialog' : 'source-properties-editor',
            dataDialogName: r,
            title: o,
            isOpened: !0,
        ...
        _renderChildren(e) {
          return ({ requestResize: t }) => {
            ...
            const { pages: i, source: s } = this.props,
              n = i.find((t) => t.id === e),
              r = (0, b.isStudy)(s) ? 'indicator-properties-dialog-tabs' : 'source-properties-editor-tabs',
              o = i.map(({ title: e, id: t }) => ({ label: e, id: t, dataId: `${r}-${t}` }))
            return a.createElement(
              a.Fragment,
              null,
              a.createElement(I.DialogTabs, {
                className: C.tabs,
                id: r,
                activeTab: e,
          ...
          render: function () {
            ...
            return a.createElement(
              ...
              a.createElement(
                ...
                null,
                a.createElement(d.PropertiesEditorTab, { page: e, tableKey: z })
              )
            )
          },
          submitOnEnterKey: !1,
