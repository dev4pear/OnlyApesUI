;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [5711],
  {
          ...
          r.createElement(
            ...
            i &&
              ...
              r.createElement(
                ...
                r.createElement(m.Icon, { className: C.icon, icon: b, 'data-name': 'close', 'data-role': 'button' })
              )
          )
        )
      }
      ...
      class B extends r.PureComponent {
        ...
        componentDidMount() {
          ...
          this.props.ignoreClosePopupsAndDialog ||
            p.subscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
            this._handleOpen(),
            void 0 !== this.props.onOpen &&
        ...
        componentWillUnmount() {
          var e, t
          this.props.ignoreClosePopupsAndDialog ||
            p.unsubscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null),
        ...
        render() {
          ...
          return r.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.SmallHeight }, (p) =>
            r.createElement(h.MatchMedia, { rule: d.DialogBreakpoints.TabletSmall }, (d) =>
              r.createElement(
                ...
                r.createElement(
                  'div',
                  { className: a()(N.wrapper, t), 'data-name': l, 'data-dialog-name': Q },
                  void 0 !== i &&
                    r.createElement(E, {
                      draggable: S && !(d || x),
                  ...
                  B && r.createElement(u.Separator, { className: N.separator }),
                  r.createElement(v.PopupContext.Consumer, null, (e) => this._renderChildren(e, d || x))
                )
              )
            )
          )
    ...
    64530: (e, t, n) => {
      ...
      function d(e) {
        ...
        return r.createElement(
          ...
          {
            ...E,
            className: i()(u.itemRow, p && !m && u.active, b && u.mobile, m && u.selected),
          ...
          C &&
            ...
            r.createElement(s.FavoriteButton, {
              className: i()(u.favoriteButton, g && u.favorite, a.CheckMobile.any() && u.mobile),
              isActive: p && !m,
              isFilled: g,
          ...
          r.createElement(
            ...
            r.createElement(
              'div',
              { className: i()(u.title, p && !m && u.active, b && u.mobile), 'data-name': 'list-item-title' },
              t
            ),
            r.createElement('div', { className: i()(u.details, p && !m && u.active, b && u.mobile) }, n)
          ),
    ...
    3085: (e, t, n) => {
      ...
      function u(e) {
        ...
        ;(0, r.useEffect)(() => {
          ...
          return (
            C ? (f && f(), e && (e.addEventListener('mousemove', S), e.addEventListener('mouseup', x))) : p && p(),
            () => {
              e && (e.removeEventListener('mousemove', S), e.removeEventListener('mouseup', x))
            }
          )
        }, [C])
        const N = t / n || 0,
        ...
        return r.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              const o = n - t
              let i = D(e.nativeEvent, (0, a.ensureNotNull)(g.current)) - w.current
              i < 0
                ? ((i = 0), (w.current = D(e.nativeEvent, (0, a.ensureNotNull)(g.current))))
                : i > o * N * B &&
                  ((i = o * N * B), (w.current = D(e.nativeEvent, (0, a.ensureNotNull)(g.current)) - i))
              d(i / N / B), E(!0)
            },
          },
          r.createElement(
            'div',
            {
              ...
              onMouseDown: function (e) {
                e.preventDefault(), (w.current = D(e.nativeEvent, (0, a.ensureNotNull)(b.current))), E(!0)
              },
            },
      ...
      function v(e) {
        ...
        return r.createElement(
          'div',
          { ...b, ref: t, className: o(n, h.scrollWrap), style: { visibility: m || g || C ? 'visible' : 'hidden' } },
          w &&
            r.createElement(u, {
              size: i - k,
              scrollSize: s - k,
        ...
        const [e, t] = (0, r.useState)(null),
          n = (0, r.useCallback)(
            ([n]) => {
              ...
              ;(r.width === (null == e ? void 0 : e.width) && r.height === e.height) || t(r)
            },
            [e]
          )
    ...
    70412: (e, t, n) => {
      'use strict'
      n.d(t, { hoverMouseEventFilter: () => i, useAccurateHover: () => a, useHover: () => o })
      var r = n(50959)
      function o() {
    ...
    96040: (e, t, n) => {
      ...
      function c(e) {
        ...
        return o.createElement(a.Icon, {
          ...p,
          'data-name': f,
          className: i(l.button, 'apply-common-tooltip', c && l.active, v && l.hidden, t),
          icon: s,
          onClick: u,
          onMouseDown: d,
