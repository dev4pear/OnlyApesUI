  ...
  [8537],
  {
    86778: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        l = i(28985),
        s = i(94474)
      const a = new n.TranslatedString('change {title} price label visibility', o.t(null, void 0, i(45936))),
        c = new n.TranslatedString('change {title} extension', o.t(null, void 0, i(86647))),
        p = new n.TranslatedString('change {title} time label visibility', o.t(null, void 0, i(33822))),
    ...
    43940: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        l = i(36298),
        s = i(28985)
      const a = new l.TranslatedString('lines width', o.t(null, void 0, i(73043))),
        c = new l.TranslatedString('lines style', o.t(null, void 0, i(41075))),
        p = new l.TranslatedString('lines color', o.t(null, void 0, i(70607))),
        d = new l.TranslatedString('backgrounds color', o.t(null, void 0, i(21926))),
        u = new l.TranslatedString('backgrounds filled', o.t(null, void 0, i(52241))),
      ...
      function y(e, t) {
        ...
        if ('linesWidths' in e || 'linestyle' in e || 'linesColors' in e) {
          const d = (0, s.createLinePropertyDefinition)(
            {
              width: e.linesWidths
                ? new r.CollectiblePropertyUndoWrapper(new n.LineToolCollectedProperty(e.linesWidths), a, t)
                : void 0,
              style: e.linestyle
                ? new r.CollectiblePropertyUndoWrapper(new n.LineToolCollectedProperty(e.linestyle), c, t)
                : void 0,
              color: e.linesColors
                ? new r.CollectiblePropertyUndoWrapper(new n.LineToolCollectedProperty(e.linesColors), p, t)
                : void 0,
            },
          ...
          const a = (0, s.createColorPropertyDefinition)(
            {
              checked: e.fillBackground
                ? new r.CollectiblePropertyUndoWrapper(new n.LineToolCollectedProperty(e.fillBackground), u, t)
                : void 0,
              color: new r.CollectiblePropertyUndoWrapper(new n.LineToolCollectedProperty(e.backgroundsColors), d, t),
            },
        ...
        if ('textsColors' in e) {
          const a = (0, s.createLinePropertyDefinition)(
            { color: new r.CollectiblePropertyUndoWrapper(new n.LineToolCollectedProperty(e.textsColors), h, t) },
    ...
    75611: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        c = i(9155),
        p = i(94474)
      const d = new n.TranslatedString('change {title} middle point visibility', o.t(null, void 0, i(89996))),
        u = new n.TranslatedString('change {title} price labels visibility', o.t(null, void 0, i(88577))),
        h = new n.TranslatedString('change {title} price range visibility', o.t(null, void 0, i(47045))),
        y = new n.TranslatedString('change {title} percent change visibility', o.t(null, void 0, i(62243))),
        f = new n.TranslatedString('change {title} change in pips visibility', o.t(null, void 0, i(22430))),
        v = new n.TranslatedString('change {title} bars range visibility', o.t(null, void 0, i(42746))),
        g = new n.TranslatedString('change {title} date/time range visibility', o.t(null, void 0, i(15485))),
        T = new n.TranslatedString('change {title} distance visibility', o.t(null, void 0, i(91534))),
        D = new n.TranslatedString('change {title} angle visibility', o.t(null, void 0, i(45537))),
        w = new n.TranslatedString('change {title} always show stats', o.t(null, void 0, i(37913))),
        _ = new n.TranslatedString('change {title} stats position', o.t(null, void 0, i(588))),
        P = [
      ...
      function z(e, t, i, o) {
        ...
        const N = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showPriceLabels, u.format({ title: i })) },
          { id: `${n}ShowPriceLabels`, title: (o && o.showPriceLabelsTitle) || m }
        )
        s.push(N)
        const R = [],
          G = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showPriceRange, h.format({ title: i })) },
            { id: `${n}PriceRange`, title: (o && o.priceRange) || C }
          )
        R.push(G)
        const E = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showPercentPriceRange, y.format({ title: i })) },
          { id: `${n}PercentChange`, title: (o && o.percentChange) || x }
        )
        R.push(E)
        const O = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showPipsPriceRange, f.format({ title: i })) },
          { id: `${n}PipsChange`, title: (o && o.pipsChange) || L }
        )
        R.push(O)
        const F = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.showBarsRange, v.format({ title: i })) },
          {
            id: `${n}BarsRange`,
        ...
        if ((R.push(F), 'showDateTimeRange' in t)) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showDateTimeRange, g.format({ title: i })) },
        ...
        if ('showDistance' in t) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showDistance, T.format({ title: i })) },
        ...
        if ('showAngle' in t) {
          const r = (0, l.createCheckablePropertyDefinition)(
            { checked: (0, l.convertToDefinitionProperty)(e, t.showAngle, D.format({ title: i })) },
            { id: `${n}Angle`, title: (o && o.angle) || M }
          )
          R.push(r)
        }
        const U = (0, l.createCheckablePropertyDefinition)(
          { checked: (0, l.convertToDefinitionProperty)(e, t.alwaysShowStats, w.format({ title: i })) },
          { id: `${n}ShowStats`, title: (o && o.showStats) || V }
        )
        R.push(U)
        const I = (0, l.createOptionsPropertyDefinition)(
          { option: (0, l.convertToDefinitionProperty)(e, t.statsPosition, _.format({ title: i })) },
          { id: `${n}StatsPosition`, title: (o && o.statsPosition) || b, options: new (a())(P) }
        )
        return (
          R.push(I), s.push((0, l.createPropertyDefinitionsGeneralGroup)(R, `${n}StatsGroup`, B)), { definitions: s }
        )
      }
    },
    2908: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        r = i(28985),
        l = i(94474)
      const s = new n.TranslatedString('change {toolName} line visibility', o.t(null, void 0, i(24272))),
        a = new n.TranslatedString('change {toolName} line width', o.t(null, void 0, i(46404))),
        c = new n.TranslatedString('change {toolName} line style', o.t(null, void 0, i(35422))),
        p = new n.TranslatedString('change {toolName} line color', o.t(null, void 0, i(50265))),
        d = new n.TranslatedString('change {toolName} line extending left', o.t(null, void 0, i(72781))),
        u = new n.TranslatedString('change {toolName} line left end', o.t(null, void 0, i(62603))),
        h = new n.TranslatedString('change {toolName} line extending right', o.t(null, void 0, i(84613))),
        y = new n.TranslatedString('change {toolName} line right end', o.t(null, void 0, i(62412))),
        f = o.t(null, void 0, i(1277)),
        v = o.t(null, void 0, i(25892)),
        g = o.t(null, void 0, i(74395))
      function T(e, t, i, o, n) {
        const T = {},
          D = { id: `${(0, l.removeSpaces)(i.originalText())}${o}`, title: (n && n.line) || f }
        return (
          void 0 !== t.showLine &&
          ...
          void 0 !== t.lineColor &&
            (T.color = (0, r.getColorDefinitionProperty)(e, t.lineColor, null, p.format({ toolName: i }))),
          void 0 !== t.extendLeft &&
            ((T.extendLeft = (0, r.convertToDefinitionProperty)(e, t.extendLeft, d.format({ toolName: i }))),
    ...
    50653: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        r = i(28985),
        l = i(94474)
      const s = new n.TranslatedString('change {toolName} text visibility', o.t(null, void 0, i(69871))),
        a = new n.TranslatedString('change {toolName} text color', o.t(null, void 0, i(6500))),
        c = new n.TranslatedString('change {toolName} text font size', o.t(null, void 0, i(48382))),
        p = new n.TranslatedString('change {toolName} text font bold', o.t(null, void 0, i(51614))),
        d = new n.TranslatedString('change {toolName} text font italic', o.t(null, void 0, i(18572))),
        u = new n.TranslatedString('change {toolName} text', o.t(null, void 0, i(77690))),
        h = new n.TranslatedString('change {toolName} labels alignment vertical', o.t(null, void 0, i(25937))),
        y = new n.TranslatedString('change {toolName} labels alignment horizontal', o.t(null, void 0, i(46991))),
        f = new n.TranslatedString('change {toolName} labels direction', o.t(null, void 0, i(73080))),
        v = new n.TranslatedString('change {toolName} text background visibility', o.t(null, void 0, i(18610))),
        g = new n.TranslatedString('change {toolName} text background color', o.t(null, void 0, i(91832))),
        T = new n.TranslatedString('change {toolName} text border visibility', o.t(null, void 0, i(45529))),
        D = new n.TranslatedString('change {toolName} text border width', o.t(null, void 0, i(6324))),
        w = new n.TranslatedString('change {toolName} text border color', o.t(null, void 0, i(44755))),
        _ = new n.TranslatedString('change {toolName} text wrap', o.t(null, void 0, i(25878))),
      ...
      function b(e, t, i, o) {
        ...
        if (
          (void 0 !== t.showText &&
            (n.checked = (0, r.convertToDefinitionProperty)(e, t.showText, s.format({ toolName: i }))),
          void 0 !== t.textColor &&
          ...
          void 0 !== t.bold && (n.bold = (0, r.convertToDefinitionProperty)(e, t.bold, p.format({ toolName: i }))),
          void 0 !== t.italic &&
          ...
          void 0 !== t.textOrientation &&
            (n.orientation = (0, r.convertToDefinitionProperty)(e, t.textOrientation, f.format({ toolName: i }))),
          ...
          void 0 !== t.backgroundTransparency && (o = t.backgroundTransparency),
            (n.backgroundColor = (0, r.getColorDefinitionProperty)(e, t.backgroundColor, o, g.format({ toolName: i })))
        }
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (b.backgroundTitle = (o.customTitles && o.customTitles.backgroundTitle) || P),
          void 0 !== t.borderVisible &&
            (n.borderVisible = (0, r.convertToDefinitionProperty)(e, t.borderVisible, T.format({ toolName: i }))),
          void 0 !== t.borderWidth &&
            (n.borderWidth = (0, r.convertToDefinitionProperty)(e, t.borderWidth, D.format({ toolName: i }))),
          void 0 !== t.borderColor &&
            (n.borderColor = (0, r.getColorDefinitionProperty)(e, t.borderColor, null, w.format({ toolName: i }))),
          (void 0 === t.borderVisible && void 0 === t.borderColor && void 0 === t.borderWidth) ||
            (b.borderTitle = (o.customTitles && o.customTitles.borderTitle) || S),
          void 0 !== t.wrap &&
            ((n.wrap = (0, r.convertToDefinitionProperty)(e, t.wrap, _.format({ toolName: i }))),
    ...
    73896: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        l = i(85766),
        s = i(28985)
      const a = new n.TranslatedString('change arrow color', o.t(null, void 0, i(38829))),
    ...
    57239: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(94474),
        a = i(50653)
      const c = new n.TranslatedString('change {title} color', o.t(null, void 0, i(20216))),
    ...
    266: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        p = i(20345),
        d = i(94474)
      const u = new n.TranslatedString('change {title} color', o.t(null, void 0, i(20216))),
        h = new n.TranslatedString('change {title} mode', o.t(null, void 0, i(94441))),
        y = new n.TranslatedString('change {title} mirrored', o.t(null, void 0, i(36618))),
        f = new n.TranslatedString('change {title} flipped', o.t(null, void 0, i(99670))),
        v = o.t(null, void 0, i(40054)),
        g = o.t(null, void 0, i(53889)),
        T = o.t(null, void 0, i(63158)),
        D = o.t(null, void 0, i(92754)),
        w = [
          { value: c.LineToolBarsPatternMode.Bars, title: o.t(null, void 0, i(25264)) },
          { value: c.LineToolBarsPatternMode.OpenClose, title: o.t(null, void 0, i(66049)) },
          { value: c.LineToolBarsPatternMode.Line, title: o.t(null, void 0, i(47669)) },
          { value: c.LineToolBarsPatternMode.LineOpen, title: o.t(null, void 0, i(17676)) },
          { value: c.LineToolBarsPatternMode.LineHigh, title: o.t(null, void 0, i(71899)) },
          { value: c.LineToolBarsPatternMode.LineLow, title: o.t(null, void 0, i(83394)) },
          { value: c.LineToolBarsPatternMode.LineHL2, title: o.t(null, void 0, i(49286)) },
        ]
          ...
          return {
            definitions: [
              ...
              (0, l.createOptionsPropertyDefinition)(
                {
                  option: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.mode, h.format({ title: i }), [
                    p.convertToInt,
                  ]),
                },
    ...
    26430: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(28985),
        a = i(94474)
      const c = new n.TranslatedString('change {title} background visibility', o.t(null, void 0, i(64548))),
        p = new n.TranslatedString('change {title} background color', o.t(null, void 0, i(75312))),
    ...
    92383: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        c = i.n(a),
        p = i(94474)
      const d = new n.TranslatedString('change {title} color', o.t(null, void 0, i(20216))),
        u = new n.TranslatedString('change {title} degree', o.t(null, void 0, i(3400))),
          ...
          return {
            definitions: [
              ...
              (0, s.createOptionsPropertyDefinition)(
                { option: (0, s.convertToDefinitionProperty)(this._propertyApplier, e.degree, u.format({ title: i })) },
    ...
    7044: (e, t, i) => {
      ...
      var o = i(50151),
        ...
        c = i(94474),
        p = i(69152)
      const d = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        u = new r.TranslatedString('change {title} levels visibility', n.t(null, void 0, i(26710))),
        h = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        y = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(90098))),
        f = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(32891))),
        v = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        g = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        T = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        D = new r.TranslatedString('change {title} coeffs as percents visibility', n.t(null, void 0, i(99128))),
    ...
    56194: (e, t, i) => {
      ...
      var o = i(50151),
        ...
        u = i(94474),
        h = i(69152)
      const y = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        f = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        v = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(32891))),
        g = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        T = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        D = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        w = new r.TranslatedString('change {title} reverse', n.t(null, void 0, i(52877))),
        _ = new r.TranslatedString('change {title} prices visibility', n.t(null, void 0, i(56175))),
        P = new r.TranslatedString('change {title} labels alignment', n.t(null, void 0, i(81170))),
        S = new r.TranslatedString('change {title} labels font size', n.t(null, void 0, i(22775))),
        m = new r.TranslatedString('change {title} style', n.t(null, void 0, i(74428))),
        b = new r.TranslatedString('change {title} fib levels based on log scale', n.t(null, void 0, i(45739))),
      ...
      class U extends a.LineDataSourceDefinitionsViewModel {
        ...
        _stylePropertyDefinitions() {
          ...
          const p = t.levelsStyle.childs(),
            ...
            I = { line: x }
          'extendLines' in t && ((U.extendRight = t.extendLines), (I.extendRightTitle = A)),
            'extendLinesLeft' in t && ((U.extendLeft = t.extendLinesLeft), (I.extendLeftTitle = $)),
            'extendRight' in t && ((U.extendRight = t.extendRight), (I.extendRightTitle = L)),
            'extendLeft' in t && ((U.extendLeft = t.extendLeft), (I.extendLeftTitle = k))
          const H = (0, l.createLineStyleDefinition)(this._propertyApplier, U, a, 'LevelsStyleLine', I)
          e.push(H)
          const j = [],
          ...
          if ('reverse' in K) {
            const t = (0, s.createCheckablePropertyDefinition)(
              {
                checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, K.reverse, w.format({ title: a })),
              },
          ...
          const Q = (0, s.createCheckablePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.showPrices, _.format({ title: a })),
            },
            { id: `${n}Prices`, title: V }
          )
          e.push(Q)
    ...
    13972: (e, t, i) => {
      ...
      const d = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        ...
        g = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        T = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        D = new r.TranslatedString('change {title} full circles visibility', n.t(null, void 0, i(35165))),
        w = n.t(null, void 0, i(4372)),
        _ = n.t(null, void 0, i(12374)),
        P = n.t(null, void 0, i(27331)),
        S = n.t(null, void 0, i(79106)),
    ...
    4841: (e, t, i) => {
      ...
      var o = i(50151),
        ...
        a = i(94474),
        c = i(69152)
      const p = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        d = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        u = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(32891))),
        h = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        y = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        f = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        v = new r.TranslatedString('change {title} left labels visibility', n.t(null, void 0, i(2359))),
        g = new r.TranslatedString('change {title} right labels visibility', n.t(null, void 0, i(16598))),
        T = new r.TranslatedString('change {title} top labels visibility', n.t(null, void 0, i(73137))),
        D = new r.TranslatedString('change {title} bottom labels visibility', n.t(null, void 0, i(15802))),
        w = new r.TranslatedString('change {title} reverse', n.t(null, void 0, i(52877))),
        _ = new r.TranslatedString('change {title} grid visibility', n.t(null, void 0, i(53770))),
        P = new r.TranslatedString('change {title} grid line color', n.t(null, void 0, i(29145))),
        S = new r.TranslatedString('change {title} grid line width', n.t(null, void 0, i(93548))),
        m = new r.TranslatedString('change {title} grid line style', n.t(null, void 0, i(64949))),
      ...
      class z extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const N = (0, l.createPropertyDefinitionsLeveledLinesGroup)(z, `${n}HLeveledLinesGroup`),
            ...
            E = (0, l.createPropertyDefinitionsGeneralGroup)([N, R, G], `${n}HLevelGroup`, x)
          e.push(E)
          const O = [],
          ...
          const U = (0, l.createPropertyDefinitionsLeveledLinesGroup)(O, `${n}VLeveledLinesGroup`),
            ...
            j = (0, l.createPropertyDefinitionsGeneralGroup)([U, I, H], `${n}VLevelGroup`, L)
          e.push(j)
    ...
    90448: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        l = i(85766),
        s = i(94474)
      const a = new n.TranslatedString('change {title} line color', o.t(null, void 0, i(20563))),
        c = new n.TranslatedString('change {title} line width', o.t(null, void 0, i(44643))),
        p = new n.TranslatedString('change {title} line style', o.t(null, void 0, i(66982))),
        d = new n.TranslatedString('change {title} counterclockwise', o.t(null, void 0, i(31804))),
              ...
              (0, r.createLinePropertyDefinition)(
                {
                  ...
                  width: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.linewidth, c.format({ title: o })),
                  style: (0, r.convertToDefinitionProperty)(this._propertyApplier, e.linestyle, p.format({ title: o })),
                },
                { id: `${i}Line`, title: u }
              ),
    ...
    18505: (e, t, i) => {
      ...
      var o = i(50151),
        ...
        p = i(94474),
        d = i(69152)
      const u = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        h = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        y = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(90098))),
        f = new r.TranslatedString('change {title} level {index} line style', n.t(null, void 0, i(47840))),
        v = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(32891))),
        g = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        T = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        D = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        w = new r.TranslatedString('change {title} labels visibility', n.t(null, void 0, i(24338))),
        _ = new r.TranslatedString('change {title} labels alignment', n.t(null, void 0, i(81170))),
      ...
      class x extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const k = (0, l.createTwoOptionsPropertyDefinition)(
            {
              checked: (0, l.convertToDefinitionProperty)(this._propertyApplier, t.showLabels, w.format({ title: s })),
            ...
            { id: `${n}Labels`, title: m, optionsItems1: new (c())(C), optionsItems2: new (c())(b) }
          )
          return e.push(k), { definitions: e }
        }
      }
    ...
    42923: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        r = i(85766),
        l = i(28985)
      const s = new n.TranslatedString('change flag color', o.t(null, void 0, i(72080))),
    ...
    85951: (e, t, i) => {
      i.r(t), i.d(t, { GannComplexAndFixedDefinitionsViewModel: () => R, isGannComplexLineTool: () => N })
      var o = i(50151),
        n = i(44352),
        r = i(36298),
        l = i(50653),
        ...
        h = i(94474),
        y = i(69152)
      const f = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        v = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        g = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(90098))),
        T = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        D = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        w = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        _ = new r.TranslatedString('change {title} reverse', n.t(null, void 0, i(52877))),
        P = new r.TranslatedString('change {title} fan {index} line visibility', n.t(null, void 0, i(89126))),
        S = new r.TranslatedString('change {title} fan {index} line color', n.t(null, void 0, i(82516))),
        m = new r.TranslatedString('change {title} fan {index} line width', n.t(null, void 0, i(30016))),
        b = new r.TranslatedString('change {title} arcs {index} line visibility', n.t(null, void 0, i(13853))),
        C = new r.TranslatedString('change {title} arcs {index} line color', n.t(null, void 0, i(17466))),
        x = new r.TranslatedString('change {title} arcs {index} line width', n.t(null, void 0, i(72307))),
        L = new r.TranslatedString('change top margin', n.t(null, void 0, i(98905))),
      ...
      class R extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const R = (0, s.createPropertyDefinitionsLeveledLinesGroup)(c, `${n}LeveledLinesGroup`)
          e.push((0, s.createPropertyDefinitionsGeneralGroup)([R], `${n}LevelGroup`, B))
          const G = [],
          ...
          const I = (0, s.createPropertyDefinitionsLeveledLinesGroup)(F, `${n}ArcsLeveledLinesGroup`)
          ...
          const X = (0, s.createCheckablePropertyDefinition)(
            { checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, t.reverse, _.format({ title: a })) },
    ...
    95399: (e, t, i) => {
      ...
      const p = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        d = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        u = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(90098))),
        h = new r.TranslatedString('change {title} level {index} line style', n.t(null, void 0, i(47840))),
        y = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        f = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        v = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        g = new r.TranslatedString('change {title} labels visibility', n.t(null, void 0, i(24338))),
          ...
          for (let i = 1; i <= _; i++) {
            const o = t[`level${i}`].childs(),
              r = (0, l.createLeveledLinePropertyDefinition)(
                ...
                { id: `${n}LineLevel${i}`, title: `${o.coeff1.value()}/${o.coeff2.value()}` }
              )
            e.push(r)
          }
    ...
    41854: (e, t, i) => {
      ...
      const p = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        ...
        y = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        f = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        v = new r.TranslatedString('change {title} reverse', n.t(null, void 0, i(52877))),
        g = new r.TranslatedString('change {title} left labels visibility', n.t(null, void 0, i(2359))),
        T = new r.TranslatedString('change {title} right labels visibility', n.t(null, void 0, i(16598))),
        D = new r.TranslatedString('change {title} top labels visibility', n.t(null, void 0, i(73137))),
        w = new r.TranslatedString('change {title} bottom labels visibility', n.t(null, void 0, i(15802))),
        _ = new r.TranslatedString('change {title} fans visibility', n.t(null, void 0, i(78142))),
        P = new r.TranslatedString('change {title} fans line color', n.t(null, void 0, i(79467))),
      ...
      class V extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const z = (0, l.createPropertyDefinitionsLeveledLinesGroup)(V, `${n}HLeveledLinesGroup`),
            ...
            G = (0, l.createPropertyDefinitionsGeneralGroup)([z, W, N, R], `${n}HLevelGroup`, b)
          e.push(G)
          const E = [],
          ...
          const F = (0, l.createPropertyDefinitionsLeveledLinesGroup)(E, `${n}VLeveledLinesGroup`),
            ...
            j = (0, l.createPropertyDefinitionsGeneralGroup)([F, U, I, H], `${n}VLevelGroup`, C)
          e.push(j)
          const Y = (0, l.createColorPropertyDefinition)(
            {
              color: (0, l.getColorDefinitionProperty)(
    ...
    83115: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        a = i(28985),
        c = i(94474)
      const p = new n.TranslatedString('change {title} background visibility', o.t(null, void 0, i(64548))),
        d = new n.TranslatedString('change {title} background color', o.t(null, void 0, i(75312))),
        u = new n.TranslatedString('change {title} extend top', o.t(null, void 0, i(896))),
        h = new n.TranslatedString('change {title} extend bottom', o.t(null, void 0, i(1447))),
        y = new n.TranslatedString('change {title} extend left', o.t(null, void 0, i(15258))),
        f = o.t(null, void 0, i(1277)),
    ...
    52266: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        a = i.n(s),
        c = i(94474)
      const p = new n.TranslatedString('change {title} candle up color', o.t(null, void 0, i(42273))),
        d = new n.TranslatedString('change {title} candle down color', o.t(null, void 0, i(38742))),
        u = new n.TranslatedString('change {title} candle border visibility', o.t(null, void 0, i(28146))),
        h = new n.TranslatedString('change {title} candle border up color', o.t(null, void 0, i(550))),
        y = new n.TranslatedString('change {title} candle border down color', o.t(null, void 0, i(7373))),
        f = new n.TranslatedString('change {title} candle wick visibility', o.t(null, void 0, i(27029))),
        v = new n.TranslatedString('change {title} candle wick color', o.t(null, void 0, i(76054))),
        g = new n.TranslatedString('change {title} transparency', o.t(null, void 0, i(84321))),
        T = new n.TranslatedString('change {title} average HL value', o.t(null, void 0, i(78680))),
        D = new n.TranslatedString('change {title} variance value', o.t(null, void 0, i(12355))),
          ...
          return {
            definitions: [
              (0, l.createNumberPropertyDefinition)(
                {
                  value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.averageHL, T.format({ title: o })),
                },
                { id: `${i}AvgHL`, title: m, type: 0, min: new (a())(1), max: new (a())(5e4), step: new (a())(1) }
              ),
              (0, l.createNumberPropertyDefinition)(
                {
                  value: (0, l.convertToDefinitionProperty)(this._propertyApplier, e.variance, D.format({ title: o })),
                },
                { id: `${i}Variance`, title: b, type: 0, min: new (a())(1), max: new (a())(100), step: new (a())(1) }
              ),
            ],
          }
        }
    ...
    53284: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        l = i(28985),
        s = i(94474)
      const a = new n.TranslatedString('change {title} color', o.t(null, void 0, i(20216))),
    ...
    77420: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(28985),
        a = i(94474)
      const c = new n.TranslatedString('change {title} background color', o.t(null, void 0, i(75312))),
        p = o.t(null, void 0, i(85206))
      class d extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
    ...
    21905: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(2908),
        a = i(94474)
      const c = new n.TranslatedString('change {title} extending left', o.t(null, void 0, i(3708))),
        p = new n.TranslatedString('change {title} extending right', o.t(null, void 0, i(52889))),
        d = new n.TranslatedString('change {title} background visibility', o.t(null, void 0, i(64548))),
        u = new n.TranslatedString('change {title} background color', o.t(null, void 0, i(75312))),
        h = o.t(null, void 0, i(27331)),
    ...
    63311: (e, t, i) => {
      ...
      class p extends s.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = new n.TranslatedString(this._source.name(), this._source.translatedType())
          return {
            definitions: [
              (0, l.createTextStyleDefinition)(
                this._propertyApplier,
    ...
    81658: (e, t, i) => {
      ...
      var o = i(50151),
        ...
        c = i(94474),
        p = i(69152)
      const d = new r.TranslatedString('change {title} extend lines', n.t(null, void 0, i(96902))),
        u = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        h = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        y = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(90098))),
        f = new r.TranslatedString('change {title} level {index} line style', n.t(null, void 0, i(47840))),
        v = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(32891))),
    ...
    769: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        a = i(58275),
        c = i.n(a)
      const p = new n.TranslatedString('change {title} style', o.t(null, void 0, i(74428))),
        d = o.t(null, void 0, i(32733)),
        u = [
          { value: s.LineToolPitchforkStyle.Original, title: o.t(null, void 0, i(25595)) },
          { value: s.LineToolPitchforkStyle.Schiff2, title: o.t(null, void 0, i(51464)) },
          { value: s.LineToolPitchforkStyle.Schiff, title: o.t(null, void 0, i(66276)) },
          { value: s.LineToolPitchforkStyle.Inside, title: o.t(null, void 0, i(9114)) },
        ]
        ...
        _stylePropertyDefinitions() {
          const e = super._stylePropertyDefinitions(),
            ...
            l = (0, r.createOptionsPropertyDefinition)(
              { option: (0, r.convertToDefinitionProperty)(this._propertyApplier, t.style, p.format({ title: o })) },
    ...
    54440: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(28985),
        a = i(94474)
      const c = new n.TranslatedString('change {title} source text color', o.t(null, void 0, i(42286))),
        p = new n.TranslatedString('change {title} source background color', o.t(null, void 0, i(18544))),
        d = new n.TranslatedString('change {title} source border color', o.t(null, void 0, i(48035))),
        u = new n.TranslatedString('change {title} target text color', o.t(null, void 0, i(27634))),
        h = new n.TranslatedString('change {title} target background color', o.t(null, void 0, i(52387))),
        y = new n.TranslatedString('change {title} target border color', o.t(null, void 0, i(6921))),
        f = new n.TranslatedString('change {title} success text color', o.t(null, void 0, i(88383))),
        v = new n.TranslatedString('change {title} success background color', o.t(null, void 0, i(26967))),
        g = new n.TranslatedString('change {title} failure text color', o.t(null, void 0, i(3156))),
        T = new n.TranslatedString('change {title} failure background color', o.t(null, void 0, i(49885))),
    ...
    11980: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(28985),
        a = i(94474)
      const c = new n.TranslatedString('change {title} line color', o.t(null, void 0, i(20563))),
          ...
          return {
            definitions: [
              (0, r.createTextStyleDefinition)(
                ...
                o,
                { isEditable: !1, isMultiLine: !1, customTitles: { text: p, borderTitle: h, backgroundTitle: y } }
              ),
              l,
            ],
          }
    ...
    12501: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        s = i(28985),
        a = i(94474)
      const c = new n.TranslatedString('change {title} background color 1', o.t(null, void 0, i(39651))),
        p = new n.TranslatedString('change {title} background color 2', o.t(null, void 0, i(78177))),
        d = o.t(null, void 0, i(48848)),
        u = o.t(null, void 0, i(27331))
      class h extends l.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
    ...
    3664: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        l = i(20061),
        s = i(50653)
      const a = new n.TranslatedString('change {title} extending left', o.t(null, void 0, i(3708))),
        c = new n.TranslatedString('change {title} extending right', o.t(null, void 0, i(52889))),
          ...
          return {
            definitions: [
              (0, s.createTextStyleDefinition)(
                ...
                new n.TranslatedString(this._source.name(), this._source.translatedType()),
                { isEditable: !0, isMultiLine: !0, alignmentVerticalItems: h, customTitles: { text: p } }
              ),
            ],
          }
        }
    ...
    30333: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        d = i.n(p),
        u = i(94474)
      const h = new n.TranslatedString('change {title} stop color', o.t(null, void 0, i(54659))),
        y = new n.TranslatedString('change {title} target color', o.t(null, void 0, i(97573))),
        f = new n.TranslatedString('change {title} price labels visibility', o.t(null, void 0, i(88577))),
        v = new n.TranslatedString('change {title} compact stats mode', o.t(null, void 0, i(35435))),
        g = new n.TranslatedString('change {title} always show stats', o.t(null, void 0, i(37913))),
        T = new n.TranslatedString('change {title} account size', o.t(null, void 0, i(31775))),
        D = new n.TranslatedString('change {title} lot size', o.t(null, void 0, i(45025))),
        w = new n.TranslatedString('change {title} risk', o.t(null, void 0, i(31553))),
        _ = new n.TranslatedString('change {title} risk display mode', o.t(null, void 0, i(40344))),
        P = new n.TranslatedString('change {title} entry price', o.t(null, void 0, i(59354))),
        S = new n.TranslatedString('change {title} profit level', o.t(null, void 0, i(44539))),
        m = new n.TranslatedString('change {title} profit price', o.t(null, void 0, i(41646))),
        b = new n.TranslatedString('change {title} stop level', o.t(null, void 0, i(89182))),
        C = new n.TranslatedString('change {title} stop price', o.t(null, void 0, i(82224))),
        ...
        _stylePropertyDefinitions() {
          ...
          return {
            definitions: [
              ...
              (0, a.createCheckablePropertyDefinition)(
                {
                  checked: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.compact, v.format({ title: o })),
                },
        ...
        _inputsPropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            l = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.accountSize, T.format({ title: o })),
              },
              {
                id: `${i}AccountSize`,
                title: N,
            ...
            s = (0, a.createNumberPropertyDefinition)(
              { value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.lotSize, D.format({ title: o })) },
              {
                id: `${i}LotSize`,
                title: R,
                type: 1,
            ...
            c = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.risk, w.format({ title: o }), [
                  (e) => parseFloat(e),
                ]),
            ...
            p = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.entryPrice, P.format({ title: o })),
              },
              { id: `${i}EntryPrice`, title: B, type: 1, step: r }
            ),
            h = (0, a.createPropertyDefinitionsGeneralGroup)([l, s, c, p], `${i}AccountRisk`),
            y = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.profitLevel, S.format({ title: o })),
              },
              {
            ...
            v = (0, a.createPropertyDefinitionsGeneralGroup)([y, f], `${i}ProfitLevel`, z),
            g = (0, a.createNumberPropertyDefinition)(
              { value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopLevel, b.format({ title: o })) },
              {
                id: `${i}StopLevelTicks`,
                title: M,
                type: 0,
            ...
            x = (0, a.createNumberPropertyDefinition)(
              {
                value: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.stopPrice, C.format({ title: o }), [
                  (e) => e,
          ...
          return { definitions: [h, v, (0, a.createPropertyDefinitionsGeneralGroup)([g, x], `${i}StopLevel`, W)] }
        }
    ...
    18613: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        p = i(41339),
        d = i(85766)
      const u = new n.TranslatedString('change vertical position Y coordinate', o.t(null, void 0, i(11049))),
        h = new n.TranslatedString('change {title} emoji visibility', o.t(null, void 0, i(65899))),
        y = new n.TranslatedString('change {title} image background color', o.t(null, void 0, i(48983))),
        f = new n.TranslatedString('change {title} emoji', o.t(null, void 0, i(65056))),
      ...
      class T extends d.LineDataSourceDefinitionsViewModel {
        ...
        _coordinatesPropertyDefinitions() {
          const e = this._source.pointsProperty().childs().points[0].childs(),
            ...
            o = {
              property: (0, a.convertToDefinitionProperty)(this._propertyApplier, e.price, u),
          ...
          return {
            definitions: [
              (0, a.createCoordinatesPropertyDefinition)(
                ...
                { id: (0, r.removeSpaces)(`${t}Coordinates${v}`), title: v, ...i.info, ...o.info }
              ),
            ],
          }
        }
    ...
    34935: (e, t, i) => {
      ...
      var o = i(44352),
        ...
        c = i(41339),
        p = i(75611)
      const d = new n.TranslatedString('change angle', o.t(null, void 0, i(1670))),
      ...
      class f extends l.LineDataSourceDefinitionsViewModel {
        _coordinatesPropertyDefinitions() {
          ...
          t.push((0, c.getCoordinatesPropertiesDefinitions)(this._propertyApplier, i, e[0], o, y, this._source.name()))
          const n = (0, r.createNumberPropertyDefinition)(
            ...
            { id: 'TrendLineAngleCoordinate', title: u, min: new (a())(-360), max: new (a())(360), step: new (a())(1) }
          )
    ...
    60007: (e, t, i) => {
      ...
      const y = new r.TranslatedString('change {title} level {index} line visibility', n.t(null, void 0, i(45463))),
        f = new r.TranslatedString('change {title} level {index} line color', n.t(null, void 0, i(85551))),
        v = new r.TranslatedString('change {title} level {index} line width', n.t(null, void 0, i(90098))),
        g = new r.TranslatedString('change {title} level {index} line style', n.t(null, void 0, i(47840))),
        T = new r.TranslatedString('change {title} level {index} line coeff', n.t(null, void 0, i(32891))),
        D = new r.TranslatedString('change {title} all lines color', n.t(null, void 0, i(15521))),
        w = new r.TranslatedString('change {title} background visibility', n.t(null, void 0, i(64548))),
        _ = new r.TranslatedString('change {title} background transparency', n.t(null, void 0, i(36438))),
        P = new r.TranslatedString('change {title} labels visibility', n.t(null, void 0, i(24338))),
        S = new r.TranslatedString('change {title} labels alignment', n.t(null, void 0, i(81170))),
      ...
      class L extends a.LineDataSourceDefinitionsViewModel {
        _stylePropertyDefinitions() {
          ...
          const V = (0, s.createTwoOptionsPropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(this._propertyApplier, i.showCoeffs, P.format({ title: p })),
              option1: (0, s.convertToDefinitionProperty)(
                this._propertyApplier,
                i.horzLabelsAlign,
                S.format({ title: p })
