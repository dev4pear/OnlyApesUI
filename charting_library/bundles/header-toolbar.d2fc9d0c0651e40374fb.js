  ...
  [3005],
  {
    ...
    54079: (e, t, s) => {
      ...
      const d = (0, n.forwardRef)(function (e, t) {
        const { onKeyDown: s, orientation: d, ...m } = e,
          v = o.PLATFORM_ACCESSIBILITY_ENABLED ? { role: 'toolbar', 'aria-orientation': d } : {},
        ...
        return (
          (0, n.useEffect)(() => {
            ...
            const e = (0, r.ensureNotNull)(p.current),
              t = () => {
                ...
                })(e).sort(o.navigationOrderComparator)
                if (0 === t.length) {
                  const [t] = h(e).sort(o.navigationOrderComparator)
                  if (void 0 === t) return
          ...
          n.createElement('div', {
            ...
            onKeyDown: (0, i.createSafeMulticastEventHandler)(function (e) {
              ...
              const s = h(e.currentTarget).sort(o.navigationOrderComparator)
    ...
    46618: (e, t, s) => {
      'use strict'
      s.r(t), s.d(t, { HeaderToolbarRenderer: () => Oe })
      var n = s(50959),
        r = s(962),
        i = s(50151),
        a = s(97754),
      ...
      function y(e) {
        ...
        return n.createElement(
          n.Fragment,
          null,
          !c && n.createElement('div', { className: g.separatorWrap }, n.createElement(S, { className: g.separator })),
          n.createElement(
            'div',
            {
              className: a(s, g.group, { [g.noMinimalWidth]: o, [g.noLeftDecoration]: r, [g.noRightDecoration]: i }),
              onClick: l,
            },
            t
          )
      ...
      var _ = s(45601),
        ...
        C = s(59468),
        w = s(45820)
      const M = { text: b.t(null, void 0, s(55646)) }
      function I(e) {
        return n.createElement(
          'div',
          { className: C.wrap },
      ...
      function B(e) {
        return n.createElement(
          ...
          n.createElement('div', { className: F.iconWrap }, n.createElement(E.Icon, { icon: L, className: F.icon }))
        )
      }
      const D = (function (e = N, t = T, s = W, r = A) {
        var o
        return (
          ((o = class extends n.PureComponent {
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: S, isVisibleLeftButton: g } = this.state,
                y = d && h
              return n.createElement(_.Measure, { onResize: u ? this._handleResizeWrap : null }, (d) =>
                n.createElement(
                  ...
                  n.createElement(
                    ...
                    c && n.createElement(e, { onClick: this._handleScrollLeft, isVisible: g }),
                    c && n.createElement(t, { onClick: this._handleScrollRight, isVisible: S })
                  )
                )
              )
            }
        ...
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              D,
              {
                isVisibleFade: v.mobiletouch && g,
                isVisibleButtons: !v.mobiletouch && g && m,
                          ...
                          n.Children.toArray([
                            ...
                            (e.Layout || e.SaveLoad) &&
                              n.createElement(
                                ...
                                !o && e.Layout && n.createElement(e.Layout, { id: h ? void 0 : x.Layouts }),
                                e.SaveLoad &&
      ...
      var Q = s(58275),
        K = s.n(Q),
        J = s(68456)
      class $ extends J.CommonJsonStoreService {
        constructor(e, t, s = []) {
      ...
      var Z = s(94025),
        ee = s(15051)
      class te extends J.AbstractJsonStoreService {
        constructor(e, t, s) {
          super(e, t, 'FAVORITE_INTERVALS_CHANGED', 'IntervalWidget.quicks', s)
        }
        _serialize(e) {
          return (0, ee.uniq)(e.map(Z.normalizeIntervalString))
        }
        _deserialize(e) {
          return (0, ee.uniq)(
            (0, Z.convertResolutionsFromSettings)(e)
      ...
      var se = s(82992),
        ...
        ie = s(56840),
        ae = s(21097)
      class oe extends J.AbstractJsonStoreService {
        constructor(e, t, s = []) {
      ...
      class ue {
        constructor(e) {
          ;(this._customIntervalsService = le),
            (this._supportedIntervalsMayChange = new (re())()),
        ...
        add(e, t, s) {
          ...
          const n = (0, Z.normalizeIntervalString)(`${e}${t}`),
            r = this.getCustomIntervals()
          return this._isIntervalDefault(n) || r.includes(n)
            ? null
            : (this._customIntervalsService.set((0, Z.sortResolutions)([...r, n])), n)
        }
        remove(e) {
      ...
      class fe {
        ...
        addFavorite(e) {
          const t = this.favId(e)
          this._favorites.push(ge(t)), this._favoritesChanged.fire(), this._saveFavs()
        }
        removeFavorite(e) {
          const t = this.favId(e),
        ...
        favId(e) {
          return (0, me.isPineIdString)(e) ? e : (0, me.extractPineId)(e) || (0, he.extractStudyId)(e)
        }
        favorites() {
      ...
      function ge(e) {
        return (0, me.isPineIdString)(e) ? { type: 'pine', pineId: e } : { type: 'java', studyId: e }
      }
      var ye = s(36274)
      const _e = {
      ...
      class be extends J.CommonJsonStoreService {
        constructor(e, t, s = _e) {
      ...
      function Ie(e = []) {
        return (0, Z.mergeResolutions)(e, d.enabled('star_some_intervals_by_default') ? we : [])
      }
      new te(ae.TVXWindowEvents, ie, Ie()),
        new $(ae.TVXWindowEvents, ie, Me()),
        new Ee.FavoriteStudyTemplateService(ae.TVXWindowEvents, ie)
      const ke = {
      ...
      class Fe extends n.PureComponent {
        constructor(e) {
          ...
          const b = Me(this.props.defaultFavoriteStyles)
          this._favoriteChartStylesService = h || new $(ae.TVXWindowEvents, ie, b)
          const E = Ie(this.props.defaultFavoriteIntervals)
          ;(this._favoriteIntervalsService = l || new te(ae.TVXWindowEvents, ie, E)),
            (this._intervalsMenuViewStateService = new be(ae.TVXWindowEvents, ie)),
            (this._intervalService = new ue(r)),
            (this._registry = {
              tools: t,
              isFundamental: o,
              chartWidgetCollection: n,
              ...
              favoriteScriptsModel: fe.getInstance(),
        ...
        render() {
          const { resizerBridge: e, allowedModes: t, ...s } = this.props,
            ...
            d = { ...u, isFake: !0, showScrollbarWhen: Le },
            h = (0, i.ensureDefined)(t),
            m = this.props.tools.PublishButtonManager || n.Fragment
          return n.createElement(
            H.RegistryProvider,
            { value: this._registry, validation: ke },
            n.createElement(
              m,
              null,
              n.createElement(
                'div',
                { className: a(Ve.toolbar, { [Ve.isHidden]: !o }), onClick: this.props.onClick },
                n.createElement(
                  'div',
        ...
        _negotiateResizer() {
          this.props.resizerBridge.negotiateHeight(
            this.state.isVisible ? de.HEADER_TOOLBAR_HEIGHT_EXPANDED : de.HEADER_TOOLBAR_HEIGHT_COLLAPSED
          )
        }
        _setDisplayMode() {
        ...
        _addCustomHTMLButton(e, t = 'left') {
          const s = new (K())(0),
            n = (0, Re.parseHtmlElement)(`<div class="apply-common-tooltip ${Ve.customButton}">`),
      ...
      class Oe {
        constructor(e, t) {
          ;(this._component = null),
            ...
            (this._container = e),
            r.render(n.createElement(Fe, { ...t, ref: this._handleRef }), this._container)
        }
        destroy() {
