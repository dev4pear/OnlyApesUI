  ...
  [5766],
  {
    41339: (e, t, i) => {
      ...
      var a = i(28985),
        ...
        u = i.n(p),
        h = i(94474)
      const y = new r.TranslatedString('change price Y coordinate', o.t(null, void 0, i(66266))),
        P = new r.TranslatedString('change bar X coordinate', o.t(null, void 0, i(23723))),
        g = new r.TranslatedString('move drawings', o.t(null, void 0, i(72223)))
      function f(e, t, i) {
        return { property: (0, a.convertToDefinitionProperty)(e, t.price, y), info: { typeY: 1, stepY: i } }
      }
      function w(e, t) {
        return {
          property: (0, a.convertToDefinitionProperty)(e, t.bar, P),
          info: { typeX: 0, minX: new (c())(-5e4), maxX: new (c())(15e3), stepX: new (c())(1) },
        }
      }
      function m(e, t, i, n, o, r) {
        ...
        return (0, a.createCoordinatesPropertyDefinition)(
          ...
          { id: (0, h.removeSpaces)(`${r}Coordinates${o}`), title: o, ...s.info, ...l.info }
        )
      }
      const v = /^([+*\-\/]?)((?:\d*)|(?:\d+\.\d*))$/
      function _(e, t, i) {
    ...
    97456: (e, t, i) => {
      ...
      var n = i(44352),
        ...
        c = i(68806),
        p = i(62513)
      const u = new o.TranslatedString('change {title} visibility on ticks', n.t(null, void 0, i(30810))),
        h = new o.TranslatedString('change {title} visibility on seconds', n.t(null, void 0, i(46948))),
        y = new o.TranslatedString('change {title} seconds from', n.t(null, void 0, i(2822))),
        P = new o.TranslatedString('change {title} seconds to', n.t(null, void 0, i(66161))),
        g = new o.TranslatedString('change {title} visibility on minutes', n.t(null, void 0, i(64370))),
        f = new o.TranslatedString('change {title} minutes from', n.t(null, void 0, i(15106))),
        w = new o.TranslatedString('change {title} minutes to', n.t(null, void 0, i(91633))),
        m = new o.TranslatedString('change {title} visibility on hours', n.t(null, void 0, i(68971))),
        v = new o.TranslatedString('change {title} hours from', n.t(null, void 0, i(35388))),
        _ = new o.TranslatedString('change {title} hours to', n.t(null, void 0, i(78586))),
        T = new o.TranslatedString('change {title} visibility on days', n.t(null, void 0, i(29088))),
        b = new o.TranslatedString('change {title} days from', n.t(null, void 0, i(41377))),
        S = new o.TranslatedString('change {title} days to', n.t(null, void 0, i(13355))),
        C = new o.TranslatedString('change {title} visibility on weeks', n.t(null, void 0, i(24941))),
        D = new o.TranslatedString('change {title} weeks from', n.t(null, void 0, i(21339))),
        k = new o.TranslatedString('change {title} weeks to', n.t(null, void 0, i(68643))),
        V = new o.TranslatedString('change {title} visibility on months', n.t(null, void 0, i(6659))),
        x = new o.TranslatedString('change {title} months from', n.t(null, void 0, i(59635))),
        W = new o.TranslatedString('change {title} months to', n.t(null, void 0, i(74266))),
        I =
        ...
        R = (n.t(null, void 0, i(86672)), new o.TranslatedString('ticks', n.t(null, void 0, i(59523)))),
        ...
        ne = (new o.TranslatedString('ranges', n.t(null, void 0, i(13604))), [1, 59]),
        oe = [1, 59],
        re = [1, 24],
        se = [1, 366],
        le = [1, 52],
      ...
      function de(e, t, i) {
        ...
        if (r.enabled('tick_resolution')) {
          const o = (0, s.createCheckablePropertyDefinition)(
            { checked: (0, s.convertToDefinitionProperty)(e, t.ticks, u.format({ title: i })) },
        ...
        if ((0, d.isSecondsEnabled)()) {
          const o = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.seconds, h.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.secondsFrom, y.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.secondsTo, P.format({ title: i })),
            },
            { id: 'IntervalsVisibilitiesSecond', title: M, min: new (a())(ne[0]), max: new (a())(ne[1]) }
          )
          n.push(o)
        }
        const o = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.minutes, g.format({ title: i })),
            ...
            { id: 'IntervalsVisibilitiesMinutes', title: U, min: new (a())(oe[0]), max: new (a())(oe[1]) }
          ),
          l = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.hours, m.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.hoursFrom, v.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.hoursTo, _.format({ title: i })),
            },
            { id: 'IntervalsVisibilitiesHours', title: A, min: new (a())(re[0]), max: new (a())(re[1]) }
          ),
          c = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.days, T.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.daysFrom, b.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.daysTo, S.format({ title: i })),
            },
            { id: 'IntervalsVisibilitiesDays', title: L, min: new (a())(se[0]), max: new (a())(se[1]) }
          )
        n.push(o, l, c)
        const p = (0, s.createRangePropertyDefinition)(
            ...
            { id: 'IntervalsVisibilitiesWeeks', title: F, min: new (a())(le[0]), max: new (a())(le[1]) }
          ),
          R = (0, s.createRangePropertyDefinition)(
            {
              checked: (0, s.convertToDefinitionProperty)(e, t.months, V.format({ title: i })),
              from: (0, s.convertToDefinitionProperty)(e, t.monthsFrom, x.format({ title: i })),
              to: (0, s.convertToDefinitionProperty)(e, t.monthsTo, W.format({ title: i })),
            },
            { id: 'IntervalsVisibilitiesMonths', title: N, min: new (a())(ae[0]), max: new (a())(ae[1]) }
          )
      ...
      function ce(e, t) {
        ...
        if (r.enabled('tick_resolution')) {
          const n = (0, s.createCheckablePropertyDefinition)(
            { checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.ticks), R, t) },
            { id: 'IntervalsVisibilitiesTicks', title: I }
          )
          i.push(n)
        }
        if ((0, d.isSecondsEnabled)()) {
          const n = (0, s.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.seconds), Y, t),
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsFrom), E, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.secondsTo), X, t),
            },
            { id: 'IntervalsVisibilitiesSecond', title: M, min: new (a())(ne[0]), max: new (a())(ne[1]) }
          )
          i.push(n)
        ...
        const n = (0, s.createRangePropertyDefinition)(
            {
              ...
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutesFrom), j, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.minutesTo), $, t),
            },
            { id: 'IntervalsVisibilitiesMinutes', title: U, min: new (a())(oe[0]), max: new (a())(oe[1]) }
          ),
          o = (0, s.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hours), K, t),
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hoursFrom), O, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.hoursTo), z, t),
            },
            { id: 'IntervalsVisibilitiesHours', title: A, min: new (a())(re[0]), max: new (a())(re[1]) }
          ),
          l = (0, s.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.days), q, t),
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysFrom), B, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.daysTo), G, t),
            },
            { id: 'IntervalsVisibilitiesDays', title: L, min: new (a())(se[0]), max: new (a())(se[1]) }
          )
        i.push(n, o, l)
        const u = (0, s.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeks), J, t),
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksFrom), Q, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.weeksTo), Z, t),
            },
            { id: 'IntervalsVisibilitiesWeeks', title: F, min: new (a())(le[0]), max: new (a())(le[1]) }
          ),
          h = (0, s.createRangePropertyDefinition)(
            {
              checked: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.months), ee, t),
              from: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.monthsFrom), te, t),
              to: new p.CollectiblePropertyUndoWrapper(new c.LineToolCollectedProperty(e.monthsTo), ie, t),
            },
            { id: 'IntervalsVisibilitiesMonths', title: N, min: new (a())(ae[0]), max: new (a())(ae[1]) }
          )
      ...
      class v {
        constructor(e, t) {
          ;(this._yCoordinateStepWV = null),
            (this._propertyPages = []),
            (this._lineToolsDoNotAffectChartInvalidation = new h.FeatureToggleWatchedValue(
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return (0, l.createPropertyPage)(
            (0, c.getIntervalsVisibilitiesPropertiesDefinitions)(
              this._undoModel,
              e,
              new r.TranslatedString(this._source.name(), this._source.title(!0))
            ),
            'visibility',
            y
          )
