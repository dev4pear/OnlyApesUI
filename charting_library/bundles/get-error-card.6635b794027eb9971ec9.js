;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [139],
  {
          ...
          for (var e = [], t = 0; t < arguments.length; t++) {
            ...
            if (r) {
              ...
              if ('string' === u || 'number' === u) e.push(r)
                ...
                i && e.push(i)
              } else if ('object' === u) for (var a in r) n.call(r, a) && r[a] && e.push(a)
            }
          }
          return e.join(' ')
        }
    ...
    81200: (e, t, r) => {
      'use strict'
      r.r(t), r.d(t, { ErrorCard: () => h, ErrorCardRenderer: () => y, ResizableErrorCard: () => m })
      var n = r(50959),
        o = r(962),
        u = r(43370),
        i = r(97754),
      ...
      function m(e) {
        ...
        return (
          ...
          n.createElement(h, { ref: f, message: r, icon: t, size: d, rawHtml: o, doNotLimitWidth: i, solutionId: l })
        )
        function m() {
          const e = f.current
          if (!e) return
          const t = e.clientHeight + c
          t < 105 ? p(0) : e.clientWidth < a || t < s ? p(1) : p(2)
        }
      }
      class y {
        constructor() {
    ...
    95257: (e, t) => {
            ...
            C(i)
              ...
              : null != i &&
                (R(i) &&
                  ...
                  })(i, o + (!i.key || (s && s.key === i.key) ? '' : ('' + i.key).replace(k, '$&/') + '/') + e)),
                t.push(i)),
            1
          )
        if (((s = 0), (u = '' === u ? '.' : u + ':'), C(e)))
      ...
      var I = { current: null },
        V = { transition: null },
        A = { ReactCurrentDispatcher: I, ReactCurrentBatchConfig: V, ReactCurrentOwner: S }
      ;(t.Children = {
        map: L,
