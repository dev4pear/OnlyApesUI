...
const s = class {
  constructor(n) {
    ...
    ;(null === (o = n.overrides) || void 0 === o ? void 0 : o['mainSeriesProperties.priceAxisProperties.lockScale']) &&
      ...
      this._options.debug &&
        (i || ((i = !0), console.log('Using CL v25.000 (internal id 1394882f @ 2023-05-22T15:05:42.670Z)'))),
      this._create()
  }
  setDebugMode(t) {
    ...
    const i = (function (t, e) {
      ...
      const o = new URL(`${t || ''}`, location.href).href,
        ...
        l = `\n${(function (t, e, n) {
          ...
          for (const a of t)
            a.endsWith('.js')
              ? i.push(`<script defer crossorigin="anonymous" src="${a.replace('__LANG__', n)}"><\/script>`)
              : s.test(a) && e === r.test(a) && o.push(`<link type="text/css" href="${a}" rel="stylesheet"/>`)
          return [...i, ...o].join('\n')
        })(s, 'rtl' === a.dir, r)}\n`
